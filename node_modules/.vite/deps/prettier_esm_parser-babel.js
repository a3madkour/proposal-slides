...
var de = v((Rf, ai) => {
  ...
  ai.exports = Dt(typeof globalThis == "object" && globalThis) || Dt(typeof window == "object" && window) || Dt(typeof self == "object" && self) || Dt(typeof global == "object" && global) || function() {
    return this;
  }() || Function("return this")();
});
var me = v((jf, ni) => {
  ni.exports = function(l) {
    try {
      return !!l();
    } catch {
      return true;
...
var Ot = v(($f, hi) => {
  var gh = Ft(), Lt = Function.prototype.call;
  hi.exports = gh ? Lt.bind(Lt) : function() {
    return Lt.apply(Lt, arguments);
  };
});
var fi = v((pi) => {
  "use strict";
  var ui = {}.propertyIsEnumerable, ci = Object.getOwnPropertyDescriptor, Ph = ci && !ui.call({ 1: 2 }, 1);
  pi.f = Ph ? function(h) {
    var f = ci(this, h);
...
var Ps = v((zf, di) => {
  di.exports = function(l, h) {
    return { enumerable: !(l & 1), configurable: !(l & 2), writable: !(l & 4), value: h };
  };
});
var ye = v((Vf, xi) => {
  var mi = Ft(), yi = Function.prototype, As = yi.call, Ah = mi && yi.bind.bind(As, As);
  xi.exports = mi ? Ah : function(l) {
    return function() {
...
var lt = v((Kf, Pi) => {
  var gi = ye(), Th = gi({}.toString), vh = gi("".slice);
  Pi.exports = function(l) {
    return vh(Th(l), 8, -1);
  };
});
var Ti = v((Wf, Ai) => {
  var Eh = ye(), bh = me(), Ch = lt(), Ts = Object, Sh = Eh("".split);
  Ai.exports = bh(function() {
    return !Ts("z").propertyIsEnumerable(0);
  }) ? function(l) {
    return Ch(l) == "String" ? Sh(l, "") : Ts(l);
  } : Ts;
});
var vs = v((Gf, vi) => {
...
var Es = v((Jf, Ei) => {
  var wh = vs(), Ih = TypeError;
  Ei.exports = function(l) {
    if (wh(l))
      throw Ih("Can't call method on " + l);
    return l;
  };
});
var Bt = v((Xf, bi) => {
...
var Cs = v((Yf, Ci) => {
  var bs = typeof document == "object" && document.all, Dh = typeof bs > "u" && bs !== void 0;
  Ci.exports = { all: bs, IS_HTMLDDA: Dh };
});
var ue = v((Qf, wi) => {
  var Si = Cs(), Fh = Si.all;
  wi.exports = Si.IS_HTMLDDA ? function(l) {
    return typeof l == "function" || l === Fh;
  } : function(l) {
    return typeof l == "function";
  };
});
var qe = v((Zf, ki) => {
  var Ii = ue(), Ni = Cs(), Lh = Ni.all;
  ki.exports = Ni.IS_HTMLDDA ? function(l) {
    return typeof l == "object" ? l !== null : Ii(l) || l === Lh;
  } : function(l) {
    return typeof l == "object" ? l !== null : Ii(l);
  };
});
var ht = v((ed, Di) => {
  var Ss = de(), Oh = ue(), Bh = function(l) {
    return Oh(l) ? l : void 0;
  };
  Di.exports = function(l, h) {
    return arguments.length < 2 ? Bh(Ss[l]) : Ss[l] && Ss[l][h];
  };
});
var Li = v((td, Fi) => {
  var Mh = ye();
  Fi.exports = Mh({}.isPrototypeOf);
});
var Bi = v((sd, Oi) => {
  var _h = ht();
  Oi.exports = _h("navigator", "userAgent") || "";
});
var $i = v((rd, Ui) => {
  var qi = de(), ws = Bi(), Mi = qi.process, _i = qi.Deno, Ri = Mi && Mi.versions || _i && _i.version, ji = Ri && Ri.v8, xe, Mt;
  ji && (xe = ji.split("."), Mt = xe[0] > 0 && xe[0] < 4 ? 1 : +(xe[0] + xe[1]));
  !Mt && ws && (xe = ws.match(/Edge\/(\d+)/), (!xe || xe[1] >= 74) && (xe = ws.match(/Chrome\/(\d+)/), xe && (Mt = +xe[1])));
  Ui.exports = Mt;
});
var Is = v((id, zi) => {
  var Hi = $i(), Rh = me();
  zi.exports = !!Object.getOwnPropertySymbols && !Rh(function() {
    var l = Symbol();
    return !String(l) || !(Object(l) instanceof Symbol) || !Symbol.sham && Hi && Hi < 41;
  });
});
var Ns = v((ad, Vi) => {
  var jh = Is();
  Vi.exports = jh && !Symbol.sham && typeof Symbol.iterator == "symbol";
});
var ks = v((nd, Ki) => {
  var qh = ht(), Uh = ue(), $h = Li(), Hh = Ns(), zh = Object;
  Ki.exports = Hh ? function(l) {
    return typeof l == "symbol";
  } : function(l) {
    var h = qh("Symbol");
    return Uh(h) && $h(h.prototype, zh(l));
  };
});
var Gi = v((od, Wi) => {
  var Vh = String;
  Wi.exports = function(l) {
    try {
      return Vh(l);
    } catch {
      return "Object";
...
var _t = v((ld, Ji) => {
  var Kh = ue(), Wh = Gi(), Gh = TypeError;
  Ji.exports = function(l) {
    if (Kh(l))
      return l;
    throw Gh(Wh(l) + " is not a function");
  };
});
var Yi = v((hd, Xi) => {
  var Jh = _t(), Xh = vs();
  Xi.exports = function(l, h) {
    var f = l[h];
    return Xh(f) ? void 0 : Jh(f);
  };
});
var Zi = v((ud, Qi) => {
  var Ds = Ot(), Fs = ue(), Ls = qe(), Yh = TypeError;
...
var Rt = v((pd, ra) => {
  var sa = de(), Qh = Object.defineProperty;
  ra.exports = function(l, h) {
    try {
      Qh(sa, l, { value: h, configurable: true, writable: true });
    } catch {
      sa[l] = h;
    }
    return h;
...
var jt = v((fd, aa) => {
  var Zh = de(), eu = Rt(), ia = "__core-js_shared__", tu = Zh[ia] || eu(ia, {});
  aa.exports = tu;
});
var Os = v((dd, oa) => {
  var su = ta(), na = jt();
  (oa.exports = function(l, h) {
    return na[l] || (na[l] = h !== void 0 ? h : {});
  })("versions", []).push({ version: "3.26.1", mode: su ? "pure" : "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.26.1/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var Bs = v((md, la) => {
  var ru = Es(), iu = Object;
  la.exports = function(l) {
    return iu(ru(l));
  };
});
var Le = v((yd, ha) => {
  var au = ye(), nu = Bs(), ou = au({}.hasOwnProperty);
  ha.exports = Object.hasOwn || function(h, f) {
    return ou(nu(h), f);
  };
});
var Ms = v((xd, ua) => {
  var lu = ye(), hu = 0, uu = Math.random(), cu = lu(1 .toString);
  ua.exports = function(l) {
    return "Symbol(" + (l === void 0 ? "" : l) + ")_" + cu(++hu + uu, 36);
  };
});
var ut = v((gd, ma) => {
  var pu = de(), fu = Os(), ca = Le(), du = Ms(), pa = Is(), da = Ns(), Qe = fu("wks"), Ue = pu.Symbol, fa = Ue && Ue.for, mu = da ? Ue : Ue && Ue.withoutSetter || du;
  ma.exports = function(l) {
    if (!ca(Qe, l) || !(pa || typeof Qe[l] == "string")) {
      var h = "Symbol." + l;
      pa && ca(Ue, l) ? Qe[l] = Ue[l] : da && fa ? Qe[l] = fa(h) : Qe[l] = mu(h);
    }
    return Qe[l];
  };
});
var Pa = v((Pd, ga) => {
  var yu = Ot(), ya = qe(), xa = ks(), xu = Yi(), gu = Zi(), Pu = ut(), Au = TypeError, Tu = Pu("toPrimitive");
  ga.exports = function(l, h) {
    if (!ya(l) || xa(l))
      return l;
    var f = xu(l, Tu), d;
    if (f) {
      if (h === void 0 && (h = "default"), d = yu(f, l, h), !ya(d) || xa(d))
        return d;
      throw Au("Can't convert object to primitive value");
    }
    return h === void 0 && (h = "number"), gu(l, h);
  };
});
var _s = v((Ad, Aa) => {
  var vu = Pa(), Eu = ks();
  Aa.exports = function(l) {
    var h = vu(l, "string");
    return Eu(h) ? h : h + "";
  };
});
var Ea = v((Td, va) => {
  var bu = de(), Ta = qe(), Rs = bu.document, Cu = Ta(Rs) && Ta(Rs.createElement);
  va.exports = function(l) {
    return Cu ? Rs.createElement(l) : {};
  };
});
var js = v((vd, ba) => {
  var Su = Se(), wu = me(), Iu = Ea();
  ba.exports = !Su && !wu(function() {
    return Object.defineProperty(Iu("div"), "a", { get: function() {
      return 7;
    } }).a != 7;
  });
});
var qs = v((Sa) => {
  var Nu = Se(), ku = Ot(), Du = fi(), Fu = Ps(), Lu = Bt(), Ou = _s(), Bu = Le(), Mu = js(), Ca = Object.getOwnPropertyDescriptor;
  Sa.f = Nu ? Ca : function(h, f) {
    if (h = Lu(h), f = Ou(f), Mu)
      try {
        return Ca(h, f);
      } catch {
    ...
    if (Bu(h, f))
      return Fu(!ku(Du.f, h, f), h[f]);
  };
});
var Ia = v((bd, wa) => {
  var _u = Se(), Ru = me();
  wa.exports = _u && Ru(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var qt = v((Cd, Na) => {
  var ju = qe(), qu = String, Uu = TypeError;
  Na.exports = function(l) {
    if (ju(l))
      return l;
    throw Uu(qu(l) + " is not an object");
  };
});
var ct = v((Da) => {
  var $u = Se(), Hu = js(), zu = Ia(), Ut = qt(), ka = _s(), Vu = TypeError, Us = Object.defineProperty, Ku = Object.getOwnPropertyDescriptor, $s = "enumerable", Hs = "configurable", zs = "writable";
  Da.f = $u ? zu ? function(h, f, d) {
    if (Ut(h), f = ka(f), Ut(d), typeof h == "function" && f === "prototype" && "value" in d && zs in d && !d[zs]) {
      var y = Ku(h, f);
      y && y[zs] && (h[f] = d.value, d = { configurable: Hs in d ? d[Hs] : y[Hs], enumerable: $s in d ? d[$s] : y[$s], writable: false });
    }
    return Us(h, f, d);
  } : Us : function(h, f, d) {
    if (Ut(h), f = ka(f), Ut(d), Hu)
      try {
        return Us(h, f, d);
      } catch {
      }
...
var Vs = v((wd, Fa) => {
  var Wu = Se(), Gu = ct(), Ju = Ps();
  Fa.exports = Wu ? function(l, h, f) {
    return Gu.f(l, h, Ju(1, f));
  } : function(l, h, f) {
    return l[h] = f, l;
  };
});
var Ba = v((Id, Oa) => {
  var Ks = Se(), Xu = Le(), La = Function.prototype, Yu = Ks && Object.getOwnPropertyDescriptor, Ws = Xu(La, "name"), Qu = Ws && function() {
  }.name === "something", Zu = Ws && (!Ks || Ks && Yu(La, "name").configurable);
  Oa.exports = { EXISTS: Ws, PROPER: Qu, CONFIGURABLE: Zu };
});
var Js = v((Nd, Ma) => {
  var ec = ye(), tc = ue(), Gs = jt(), sc = ec(Function.toString);
  tc(Gs.inspectSource) || (Gs.inspectSource = function(l) {
    return sc(l);
  });
  Ma.exports = Gs.inspectSource;
});
var ja = v((kd, Ra) => {
  var rc = de(), ic = ue(), _a = rc.WeakMap;
  Ra.exports = ic(_a) && /native code/.test(String(_a));
});
var $a = v((Dd, Ua) => {
  var ac = Os(), nc = Ms(), qa = ac("keys");
  Ua.exports = function(l) {
    return qa[l] || (qa[l] = nc(l));
  };
});
var Xs = v((Fd, Ha) => {
  Ha.exports = {};
...
var Wa = v((Ld, Ka) => {
  var oc = ja(), Va = de(), lc = qe(), hc = Vs(), Ys = Le(), Qs = jt(), uc = $a(), cc = Xs(), za = "Object already initialized", Zs = Va.TypeError, pc = Va.WeakMap, $t, pt, Ht, fc = function(l) {
    return Ht(l) ? pt(l) : $t(l, {});
  }, dc = function(l) {
    return function(h) {
      var f;
      if (!lc(h) || (f = pt(h)).type !== l)
        throw Zs("Incompatible receiver, " + l + " required");
      return f;
    };
  };
  oc || Qs.state ? (ge = Qs.state || (Qs.state = new pc()), ge.get = ge.get, ge.has = ge.has, ge.set = ge.set, $t = function(l, h) {
    if (ge.has(l))
      throw Zs(za);
    return h.facade = l, ge.set(l, h), h;
  }, pt = function(l) {
    return ge.get(l) || {};
  }, Ht = function(l) {
    return ge.has(l);
  }) : ($e = uc("state"), cc[$e] = true, $t = function(l, h) {
    if (Ys(l, $e))
      throw Zs(za);
    return h.facade = l, hc(l, $e, h), h;
  }, pt = function(l) {
    return Ys(l, $e) ? l[$e] : {};
  }, Ht = function(l) {
    return Ys(l, $e);
  ...
  var ge, $e;
  Ka.exports = { set: $t, get: pt, has: Ht, enforce: fc, getterFor: dc };
});
var tr = v((Od, Ja) => {
  var mc = me(), yc = ue(), zt = Le(), er = Se(), xc = Ba().CONFIGURABLE, gc = Js(), Ga = Wa(), Pc = Ga.enforce, Ac = Ga.get, Vt = Object.defineProperty, Tc = er && !mc(function() {
    return Vt(function() {
    }, "length", { value: 8 }).length !== 8;
  }), vc = String(String).split("String"), Ec = Ja.exports = function(l, h, f) {
    String(h).slice(0, 7) === "Symbol(" && (h = "[" + String(h).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), f && f.getter && (h = "get " + h), f && f.setter && (h = "set " + h), (!zt(l, "name") || xc && l.name !== h) && (er ? Vt(l, "name", { value: h, configurable: true }) : l.name = h), Tc && f && zt(f, "arity") && l.length !== f.arity && Vt(l, "length", { value: f.arity });
    try {
      f && zt(f, "constructor") && f.constructor ? er && Vt(l, "prototype", { writable: false }) : l.prototype && (l.prototype = void 0);
    } catch {
    }
    var d = Pc(l);
    return zt(d, "source") || (d.source = vc.join(typeof h == "string" ? h : "")), l;
  };
  Function.prototype.toString = Ec(function() {
    return yc(this) && Ac(this).source || gc(this);
  }, "toString");
});
var Ya = v((Bd, Xa) => {
  var bc = ue(), Cc = ct(), Sc = tr(), wc = Rt();
  Xa.exports = function(l, h, f, d) {
    d || (d = {});
    var y = d.enumerable, g = d.name !== void 0 ? d.name : h;
    if (bc(f) && Sc(f, g, d), d.global)
      y ? l[h] = f : wc(h, f);
    else {
      try {
      ...
      y ? l[h] = f : Cc.f(l, h, { value: f, enumerable: false, configurable: !d.nonConfigurable, writable: !d.nonWritable });
    }
    return l;
  };
});
var Za = v((Md, Qa) => {
  var Ic = Math.ceil, Nc = Math.floor;
  Qa.exports = Math.trunc || function(h) {
    var f = +h;
    return (f > 0 ? Nc : Ic)(f);
  };
});
var sr = v((_d, en) => {
  var kc = Za();
  en.exports = function(l) {
    var h = +l;
    return h !== h || h === 0 ? 0 : kc(h);
  };
});
var sn = v((Rd, tn) => {
  var Dc = sr(), Fc = Math.max, Lc = Math.min;
  tn.exports = function(l, h) {
    var f = Dc(l);
    return f < 0 ? Fc(f + h, 0) : Lc(f, h);
  };
});
var an = v((jd, rn) => {
  var Oc = sr(), Bc = Math.min;
  rn.exports = function(l) {
    return l > 0 ? Bc(Oc(l), 9007199254740991) : 0;
  };
});
var Kt = v((qd, nn) => {
  var Mc = an();
...
var hn = v((Ud, ln) => {
  var _c = Bt(), Rc = sn(), jc = Kt(), on = function(l) {
    return function(h, f, d) {
      var y = _c(h), g = jc(y), A = Rc(d, g), E;
      if (l && f != f) {
        for (; g > A; )
          if (E = y[A++], E != E)
            return true;
  ...
  ln.exports = { includes: on(true), indexOf: on(false) };
});
var pn = v(($d, cn) => {
  var qc = ye(), rr = Le(), Uc = Bt(), $c = hn().indexOf, Hc = Xs(), un = qc([].push);
  cn.exports = function(l, h) {
    var f = Uc(l), d = 0, y = [], g;
    for (g in f)
      !rr(Hc, g) && rr(f, g) && un(y, g);
    for (; h.length > d; )
      rr(f, g = h[d++]) && (~$c(y, g) || un(y, g));
    return y;
  };
});
var dn = v((Hd, fn) => {
  fn.exports = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"];
});
var yn = v((mn) => {
  var zc = pn(), Vc = dn(), Kc = Vc.concat("length", "prototype");
  mn.f = Object.getOwnPropertyNames || function(h) {
    return zc(h, Kc);
  };
});
var gn = v((xn) => {
...
var An = v((Kd, Pn) => {
  var Wc = ht(), Gc = ye(), Jc = yn(), Xc = gn(), Yc = qt(), Qc = Gc([].concat);
  Pn.exports = Wc("Reflect", "ownKeys") || function(h) {
    var f = Jc.f(Yc(h)), d = Xc.f;
    return d ? Qc(f, d(h)) : f;
  };
});
var En = v((Wd, vn) => {
  var Tn = Le(), Zc = An(), ep = qs(), tp = ct();
  vn.exports = function(l, h, f) {
    for (var d = Zc(h), y = tp.f, g = ep.f, A = 0; A < d.length; A++) {
      var E = d[A];
      !Tn(l, E) && !(f && Tn(f, E)) && y(l, E, g(h, E));
    }
  };
});
var Cn = v((Gd, bn) => {
  var sp = me(), rp = ue(), ip = /#|\.prototype\./, ft = function(l, h) {
    var f = np[ap(l)];
    return f == lp ? true : f == op ? false : rp(h) ? sp(h) : !!h;
  }, ap = ft.normalize = function(l) {
    return String(l).replace(ip, ".").toLowerCase();
  }, np = ft.data = {}, op = ft.NATIVE = "N", lp = ft.POLYFILL = "P";
  bn.exports = ft;
});
var ar = v((Jd, Sn) => {
  var ir = de(), hp = qs().f, up = Vs(), cp = Ya(), pp = Rt(), fp = En(), dp = Cn();
  Sn.exports = function(l, h) {
    var f = l.target, d = l.global, y = l.stat, g, A, E, S, L, I;
    if (d ? A = ir : y ? A = ir[f] || pp(f, {}) : A = (ir[f] || {}).prototype, A)
      for (E in h) {
        if (L = h[E], l.dontCallGetSet ? (I = hp(A, E), S = I && I.value) : S = A[E], g = dp(d ? E : f + (y ? "." : "#") + E, l.forced), !g && S !== void 0) {
          if (typeof L == typeof S)
            continue;
          fp(L, S);
        }
        (l.sham || S && S.sham) && up(L, "sham", true), cp(A, E, L, l);
      }
  };
});
var wn = v(() => {
  var mp = ar(), nr = de();
  mp({ global: true, forced: nr.globalThis !== nr }, { globalThis: nr });
});
var kn = v((Qd, Nn) => {
  var In = tr(), yp = ct();
  Nn.exports = function(l, h, f) {
    return f.get && In(f.get, h, { getter: true }), f.set && In(f.set, h, { setter: true }), yp.f(l, h, f);
  };
});
var Fn = v((Zd, Dn) => {
  "use strict";
...
var or = v((em, Bn) => {
  var bp = lt();
  Bn.exports = Array.isArray || function(h) {
    return bp(h) == "Array";
  };
});
var _n = v((tm, Mn) => {
  var Cp = TypeError, Sp = 9007199254740991;
  Mn.exports = function(l) {
    if (l > Sp)
      throw Cp("Maximum allowed index exceeded");
    return l;
  };
});
var jn = v((sm, Rn) => {
...
var $n = v((rm, Un) => {
  var qn = jn(), Np = _t(), kp = Ft(), Dp = qn(qn.bind);
  Un.exports = function(l, h) {
    return Np(l), h === void 0 ? l : kp ? Dp(l, h) : function() {
...
var Vn = v((im, zn) => {
  "use strict";
  var Fp = or(), Lp = Kt(), Op = _n(), Bp = $n(), Hn = function(l, h, f, d, y, g, A, E) {
    for (var S = y, L = 0, I = A ? Bp(A, E) : false, C, O; L < d; )
      L in f && (C = I ? I(f[L], L, h) : f[L], g > 0 && Fp(C) ? (O = Lp(C), S = Hn(l, h, C, O, S, g - 1) - 1) : (Op(S + 1), l[S] = C), S++), L++;
    return S;
  };
  zn.exports = Hn;
});
var Gn = v((am, Wn) => {
  var Mp = ut(), _p = Mp("toStringTag"), Kn = {};
  Kn[_p] = "z";
  Wn.exports = String(Kn) === "[object z]";
});
var Xn = v((nm, Jn) => {
  var Rp = Gn(), jp = ue(), Wt = lt(), qp = ut(), Up = qp("toStringTag"), $p = Object, Hp = Wt(function() {
    return arguments;
  }()) == "Arguments", zp = function(l, h) {
    try {
      return l[h];
    } catch {
    }
  };
  Jn.exports = Rp ? Wt : function(l) {
    var h, f, d;
    return l === void 0 ? "Undefined" : l === null ? "Null" : typeof (f = zp(h = $p(l), Up)) == "string" ? f : Hp ? Wt(h) : (d = Wt(h)) == "Object" && jp(h.callee) ? "Arguments" : d;
  };
});
var so = v((om, to) => {
  var Vp = ye(), Kp = me(), Yn = ue(), Wp = Xn(), Gp = ht(), Jp = Js(), Qn = function() {
  }, Xp = [], Zn = Gp("Reflect", "construct"), lr = /^\s*(?:class|function)\b/, Yp = Vp(lr.exec), Qp = !lr.exec(Qn), dt = function(h) {
    if (!Yn(h))
      return false;
    try {
      return Zn(Qn, Xp, h), true;
    } catch {
      return false;
    }
  }, eo = function(h) {
    ...
    try {
      return Qp || !!Yp(lr, Jp(h));
    } catch {
      return true;
    }
  };
  eo.sham = true;
  to.exports = !Zn || Kp(function() {
    var l;
    return dt(dt.call) || !dt(Object) || !dt(function() {
      l = true;
    }) || l;
  }) ? eo : dt;
});
var no = v((lm, ao) => {
  var ro = or(), Zp = so(), ef = qe(), tf = ut(), sf = tf("species"), io = Array;
  ao.exports = function(l) {
    var h;
    return ro(l) && (h = l.constructor, Zp(h) && (h === io || ro(h.prototype)) ? h = void 0 : ef(h) && (h = h[sf], h === null && (h = void 0))), h === void 0 ? io : h;
  };
});
var lo = v((hm, oo) => {
  var rf = no();
  oo.exports = function(l, h) {
    return new (rf(l))(h === 0 ? 0 : h);
  };
});
wn();
var gp = de();
...
var Ep = Pp && vp(function() {
  ...
  var h = {}, f = "", d = l ? "dgimsy" : "gimsy", y = function(S, L) {
    Object.defineProperty(h, S, { get: function() {
      return f += L, true;
    } });
  }, g = { dotAll: "s", global: "g", ignoreCase: "i", multiline: "m", sticky: "y" };
  l && (g.hasIndices = "d");
  for (var A in g)
    y(A, g[A]);
  var E = Object.getOwnPropertyDescriptor(On, "flags").get.call(h);
  return E !== d || f !== d;
});
Ep && Ap(On, "flags", { configurable: true, get: Tp });
var af = ar();
var nf = Vn();
var of = _t();
var lf = Bs();
var hf = Kt();
var uf = lo();
af({ target: "Array", proto: true }, { flatMap: function(h) {
  var f = lf(this), d = hf(f), y;
  return of(h), y = uf(f, 0), y.length = nf(y, f, f, d, 0, 1, h, arguments.length > 1 ? arguments[1] : void 0), y;
} });
...
var df = (l, h, f, d) => {
  if (h && typeof h == "object" || typeof h == "function")
    for (let y of fr(h))
      !pf.call(l, y) && y !== f && pr(l, y, { get: () => h[y], enumerable: !(d = cf(h, y)) || d.enumerable });
  return l;
};
var mf = (l) => df(pr({}, "__esModule", { value: true }), l);
var K = ho({ "<define:process>"() {
} });
var yf = W({ "src/utils/try-combinations.js"(l, h) {
  "use strict";
  K();
  function f() {
    let d;
    for (var y = arguments.length, g = new Array(y), A = 0; A < y; A++)
      g[A] = arguments[A];
    for (let [E, S] of g.entries())
      try {
        return { result: S() };
      } catch (L) {
        E === 0 && (d = L);
...
var uo = W({ "src/language-js/utils/get-shebang.js"(l, h) {
  "use strict";
  K();
  function f(d) {
    if (!d.startsWith("#!"))
...
var xf = W({ "src/utils/text/skip-inline-comment.js"(l, h) {
  "use strict";
  K();
  function f(d, y) {
    if (y === false)
...
var gf = W({ "src/utils/text/skip-newline.js"(l, h) {
  "use strict";
  K();
  function f(d, y, g) {
    let A = g && g.backwards;
...
var co = W({ "src/utils/text/skip.js"(l, h) {
  "use strict";
  K();
  function f(E) {
    return (S, L, I) => {
      ...
      return R === -1 || R === O ? R : false;
    };
  }
  var d = f(/\s/), y = f(" 	"), g = f(",; 	"), A = f(/[^\n\r]/);
  h.exports = { skipWhitespace: d, skipSpaces: y, skipToLineEnd: g, skipEverythingButNewLine: A };
} });
var Pf = W({ "src/utils/text/skip-trailing-comment.js"(l, h) {
  "use strict";
  K();
  var { skipEverythingButNewLine: f } = co();
  function d(y, g) {
    return g === false ? false : y.charAt(g) === "/" && y.charAt(g + 1) === "/" ? f(y, g) : g;
  }
  h.exports = d;
} });
var Af = W({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l, h) {
  "use strict";
  K();
  var f = xf(), d = gf(), y = Pf(), { skipSpaces: g } = co();
  function A(E, S) {
    let L = null, I = S;
    for (; I !== L; )
      L = I, I = g(E, I), I = f(E, I), I = y(E, I), I = d(E, I);
    return I;
  }
  h.exports = A;
} });
var po = {};
ff(po, { EOL: () => cr, arch: () => Tf, cpus: () => Ao, default: () => Co, endianness: () => fo, freemem: () => go, getNetworkInterfaces: () => bo, hostname: () => mo, loadavg: () => yo, networkInterfaces: () => Eo, platform: () => vf, release: () => vo, tmpDir: () => hr, tmpdir: () => ur, totalmem: () => Po, type: () => To, uptime: () => xo });
function fo() {
  if (typeof Gt > "u") {
...
var cr;
var Co;
var Ef = ho({ "node-modules-polyfills:os"() {
  K(), ur = hr, cr = `
`, Co = { EOL: cr, tmpdir: ur, tmpDir: hr, networkInterfaces: Eo, getNetworkInterfaces: bo, release: vo, type: To, cpus: Ao, totalmem: Po, freemem: go, uptime: xo, loadavg: yo, hostname: mo, endianness: fo };
} });
var bf = W({ "node-modules-polyfills-commonjs:os"(l, h) {
  K();
  var f = (Ef(), mf(po));
  if (f && f.default) {
    h.exports = f.default;
...
var Cf = W({ "node_modules/detect-newline/index.js"(l, h) {
  "use strict";
  K();
  var f = (d) => {
    if (typeof d != "string")
...
var Sf = W({ "node_modules/jest-docblock/build/index.js"(l) {
  "use strict";
  K(), Object.defineProperty(l, "__esModule", { value: true }), l.extract = R, l.parse = H, l.parseWithComments = J, l.print = D, l.strip = N;
  function h() {
    let u = bf();
    return h = function() {
      return u;
  ...
  function J(u) {
    let X = (0, f().default)(u) || h().EOL;
    u = u.replace(g, "").replace(y, "").replace(C, "$1");
    let ne = "";
    for (; ne !== u; )
      ne = u, u = u.replace(L, `${X}$1 $2${X}`);
    u = u.replace(S, "").trimRight();
    let Q = /* @__PURE__ */ Object.create(null), we = u.replace(I, "").replace(S, "").trimRight(), ee;
    for (; ee = I.exec(u); ) {
      let U = ee[2].replace(E, "");
      typeof Q[ee[1]] == "string" || Array.isArray(Q[ee[1]]) ? Q[ee[1]] = O.concat(Q[ee[1]], U) : Q[ee[1]] = U;
    }
    return { comments: we, pragmas: Q };
  }
  function D(u) {
    let { comments: X = "", pragmas: ne = {} } = u, Q = (0, f().default)(X) || h().EOL, we = "/**", ee = " *", U = " */", B = Object.keys(ne), T = B.map((V) => _(V, ne[V])).reduce((V, Y) => V.concat(Y), []).map((V) => `${ee} ${V}${Q}`).join("");
    if (!X) {
      if (B.length === 0)
        return "";
      if (B.length === 1 && !Array.isArray(ne[B[0]])) {
        let V = ne[B[0]];
        return `${we} ${_(B[0], V)[0]}${U}`;
      }
    }
    let Oe = X.split(Q).map((V) => `${ee} ${V}`).join(Q) + Q;
    return we + Q + (X ? Oe : "") + (X && B.length ? ee + Q : "") + T + U;
  }
  function _(u, X) {
    return O.concat(X).map((ne) => `@${u} ${ne}`.trim());
  }
} });
var wf = W({ "src/common/end-of-line.js"(l, h) {
  "use strict";
  K();
  function f(A) {
    let E = A.indexOf("\r");
    return E >= 0 ? A.charAt(E + 1) === `
` ? "crlf" : "cr" : "lf";
  }
  function d(A) {
    switch (A) {
...
`);
  ...
  h.exports = { guessEndOfLine: f, convertEndOfLineToChars: d, countEndOfLineChars: y, normalizeEndOfLine: g };
} });
var If = W({ "src/language-js/pragma.js"(l, h) {
  "use strict";
  K();
  var { parseWithComments: f, strip: d, extract: y, print: g } = Sf(), { normalizeEndOfLine: A } = wf(), E = uo();
  function S(C) {
    let O = E(C);
    O && (C = C.slice(O.length + 1));
    let R = y(C), { pragmas: N, comments: H } = f(R);
    return { shebang: O, text: C, pragmas: N, comments: H };
  }
  function L(C) {
    let O = Object.keys(S(C).pragmas);
    return O.includes("prettier") || O.includes("format");
  }
  function I(C) {
    let { shebang: O, text: R, pragmas: N, comments: H } = S(C), J = d(R), D = g({ pragmas: Object.assign({ format: "" }, N), comments: H.trimStart() });
    return (O ? `${O}
` : "") + A(D) + (J.startsWith(`
`) ? `
` : `
...
`) + J;
  ...
  h.exports = { hasPragma: L, insertPragma: I };
} });
var dr = W({ "src/utils/is-non-empty-array.js"(l, h) {
  "use strict";
  K();
  function f(d) {
...
var So = W({ "src/language-js/loc.js"(l, h) {
  "use strict";
  K();
  var f = dr();
  function d(S) {
    var L, I;
    let C = S.range ? S.range[0] : S.start, O = (L = (I = S.declaration) === null || I === void 0 ? void 0 : I.decorators) !== null && L !== void 0 ? L : S.decorators;
    return f(O) ? Math.min(d(O[0]), C) : C;
  }
  function y(S) {
  ...
  function g(S, L) {
    let I = d(S);
    return Number.isInteger(I) && I === d(L);
  }
  function A(S, L) {
    let I = y(S);
    return Number.isInteger(I) && I === y(L);
  }
  function E(S, L) {
    return g(S, L) && A(S, L);
  }
  h.exports = { locStart: d, locEnd: y, hasSameLocStart: g, hasSameLoc: E };
} });
var wo = W({ "src/language-js/parse/utils/create-parser.js"(l, h) {
  "use strict";
  K();
  var { hasPragma: f } = If(), { locStart: d, locEnd: y } = So();
  function g(A) {
    return A = typeof A == "function" ? { parse: A } : A, Object.assign({ astFormat: "estree", hasPragma: f, locStart: d, locEnd: y }, A);
  }
  h.exports = g;
} });
var mr = W({ "src/common/parser-create-error.js"(l, h) {
  "use strict";
  K();
  function f(d, y) {
    let g = new SyntaxError(d + " (" + y.start.line + ":" + y.start.column + ")");
    return g.loc = y, g;
  }
  h.exports = f;
} });
var Io = W({ "src/language-js/parse/utils/create-babel-parse-error.js"(l, h) {
  "use strict";
  K();
  var f = mr();
  function d(y) {
    let { message: g, loc: A } = y;
    return f(g.replace(/ \(.*\)/, ""), { start: { line: A ? A.line : 0, column: A ? A.column + 1 : 0 } });
  }
  h.exports = d;
} });
var Nf = W({ "src/language-js/utils/is-ts-keyword-type.js"(l, h) {
  "use strict";
  K();
  function f(d) {
    let { type: y } = d;
...
var kf = W({ "src/language-js/utils/is-block-comment.js"(l, h) {
  "use strict";
  K();
  var f = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), d = (y) => f.has(y == null ? void 0 : y.type);
  h.exports = d;
} });
var Df = W({ "src/language-js/utils/is-type-cast-comment.js"(l, h) {
  "use strict";
  K();
  var f = kf();
  function d(y) {
...
var Ff = W({ "src/utils/get-last.js"(l, h) {
  "use strict";
  K();
  var f = (d) => d[d.length - 1];
  h.exports = f;
} });
var No = W({ "src/language-js/parse/postprocess/visit-node.js"(l, h) {
  "use strict";
  K();
  function f(d, y) {
    if (Array.isArray(d)) {
...
var ko = W({ "src/language-js/parse/postprocess/throw-syntax-error.js"(l, h) {
  "use strict";
  K();
  var f = mr();
  function d(y, g) {
    let { start: A, end: E } = y.loc;
    throw f(g, { start: { line: A.line, column: A.column + 1 }, end: { line: E.line, column: E.column + 1 } });
  }
  h.exports = d;
} });
var Lf = W({ "src/language-js/parse/postprocess/typescript.js"(l, h) {
  "use strict";
  K();
  var f = dr(), d = No(), y = ko(), g = { AbstractKeyword: 126, SourceFile: 308, PropertyDeclaration: 169 };
  function A(I) {
    for (; I && I.kind !== g.SourceFile; )
      I = I.parent;
    return I;
  }
  function E(I) {
    ...
    if (!f(C))
      return;
    let [{ expression: O }] = C, R = A(O), [N, H] = [O.pos, O.end].map((J) => {
      let { line: D, character: _ } = R.getLineAndCharacterOfPosition(J);
      return { line: D + 1, column: _ };
    });
    y({ loc: { start: N, end: H } }, "Decorators are not valid here.");
  }
  function S(I, C) {
    I.kind !== g.PropertyDeclaration || I.modifiers && !I.modifiers.some((O) => O.kind === g.AbstractKeyword) || I.initializer && C.value === null && y(C, "Abstract property cannot have an initializer");
  }
  function L(I, C) {
    let { esTreeNodeToTSNodeMap: O, tsNodeToESTreeNodeMap: R } = C.tsParseResult;
    d(I, (N) => {
      let H = O.get(N);
      if (!H)
        return;
  ...
  h.exports = { throwErrorForInvalidNodes: L };
} });
var Of = W({ "src/language-js/parse/postprocess/index.js"(l, h) {
  "use strict";
  K();
  var { locStart: f, locEnd: d } = So(), y = Nf(), g = Df(), A = Ff(), E = No(), { throwErrorForInvalidNodes: S } = Lf(), L = ko();
  function I(N, H) {
    if (H.parser === "typescript" && /@|abstract/.test(H.originalText) && S(N, H), H.parser !== "typescript" && H.parser !== "flow" && H.parser !== "acorn" && H.parser !== "espree" && H.parser !== "meriyah") {
      let D = /* @__PURE__ */ new Set();
      N = E(N, (_) => {
        _.leadingComments && _.leadingComments.some(g) && D.add(f(_));
      }), N = E(N, (_) => {
    ...
    return N = E(N, (D) => {
      switch (D.type) {
        ...
        case "VariableDeclaration": {
          let _ = A(D.declarations);
          _ && _.init && J(D, _);
          break;
        }
        case "TSParenthesizedType":
          return y(D.typeAnnotation) || D.typeAnnotation.type === "TSThisType" || (D.typeAnnotation.range = [f(D), d(D)]), D.typeAnnotation;
        case "TSTypeParameter":
          if (typeof D.name == "string") {
            let _ = f(D);
            D.name = { type: "Identifier", name: D.name, range: [_, _ + D.name.length] };
          }
          break;
        case "ObjectExpression":
          if (H.parser === "typescript") {
            let _ = D.properties.find((u) => u.type === "Property" && u.value.type === "TSEmptyBodyFunctionExpression");
            _ && L(_.value, "Unexpected token.");
          }
          break;
        case "SequenceExpression": {
          let _ = A(D.expressions);
          D.range = [f(D), Math.min(d(_), d(D))];
          break;
        }
        case "TopicReference":
        ...
        case "ExportAllDeclaration": {
          ...
          if (H.parser === "meriyah" && _ && _.type === "Identifier") {
            ...
            (u.startsWith('"') || u.startsWith("'")) && (D.exported = Object.assign(Object.assign({}, D.exported), {}, { type: "Literal", value: D.exported.name, raw: u }));
          }
          break;
        }
        case "PropertyDefinition":
          if (H.parser === "meriyah" && D.static && !D.computed && !D.key) {
            let _ = "static", u = f(D);
            Object.assign(D, { static: false, key: { type: "Identifier", name: _, range: [u, u + _.length] } });
          }
          break;
      }
    }), N;
    function J(D, _) {
      H.originalText[d(_)] !== ";" && (D.range = [f(D), d(_)]);
    }
  }
  function C(N) {
    switch (N.type) {
      case "CallExpression":
        N.type = "OptionalCallExpression", N.callee = C(N.callee);
        break;
      case "MemberExpression":
        N.type = "OptionalMemberExpression", N.object = C(N.object);
        break;
      case "TSNonNullExpression":
        N.expression = C(N.expression);
        break;
    }
    return N;
  }
  ...
  function R(N) {
    return O(N) ? R({ type: "LogicalExpression", operator: N.operator, left: R({ type: "LogicalExpression", operator: N.operator, left: N.left, right: N.right.left, range: [f(N.left), d(N.right.left)] }), right: N.right.right, range: [f(N), d(N)] }) : N;
  }
  h.exports = I;
} });
var Do = W({ "node_modules/@babel/parser/lib/index.js"(l) {
  "use strict";
  K(), Object.defineProperty(l, "__esModule", { value: true });
  function h(t, r) {
    if (t == null)
      return {};
  ...
  var g = { SyntaxError: "BABEL_PARSER_SYNTAX_ERROR", SourceTypeModuleError: "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED" }, A = function(t) {
  ...
  }, E = (t, r, e) => Object.keys(e).map((s) => [s, e[s]]).filter((s) => {
    let [, i] = s;
    return !!i;
  }).map((s) => {
    let [i, a] = s;
    return [i, typeof a == "function" ? { value: a, enumerable: false } : typeof a.reflect == "string" ? Object.assign({}, a, A(a.reflect.split("."))) : a];
  }).reduce((s, i) => {
    let [a, n] = i;
    ...
    return r === "UpdateExpression" ? L.UpdateExpression[String(e)] : L[r];
...
- Did you mean \`import { "${r}" as foo }\`?`;
  ...
  }, YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, O = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: (t) => {
    let { referenceName: r } = t;
    return `Assigning to '${r}' in strict mode.`;
  }, StrictEvalArgumentsBinding: (t) => {
    let { bindingName: r } = t;
    return `Binding '${r}' in strict mode.`;
  }, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, R = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), N = { PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: (t) => {
    let { token: r } = t;
  ...
  function _(t, r) {
    ...
    for (let s of Object.keys(t)) {
      let i = t[s], a = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = a, o = h(a, J), c = typeof n == "string" ? () => n : n;
      e[s] = D(Object.assign({ code: g.SyntaxError, reasonCode: s, toMessage: c }, r ? { syntaxPlugin: r } : {}, o));
    }
    return e;
  }
  var u = Object.assign({}, _(S), _(C), _(O), _`pipelineOperator`(N)), { defineProperty: X } = Object, ne = (t, r) => X(t, r, { enumerable: false, value: t[r] });
  function Q(t) {
    return t.loc.start && ne(t.loc.start, "index"), t.loc.end && ne(t.loc.end, "index"), t;
  }
  var we = (t) => class extends t {
    parse() {
      let e = Q(super.parse());
    ...
    finishNodeAt(e, s, i) {
      return Q(super.finishNodeAt(e, s, i));
    }
    resetStartLocation(e, s) {
      super.resetStartLocation(e, s), Q(e);
    }
    resetEndLocation(e) {
  ...
  }, U = { brace: new ee("{"), j_oTag: new ee("<tag"), j_cTag: new ee("</tag"), j_expr: new ee("<tag>...</tag>", true) };
  U.template = new ee("`", true);
  var B = true, T = true, Oe = true, V = true, Y = true, Pe = true, ce = class {
    constructor(t) {
  ...
  function ve(t) {
    return t < 65 ? t === 36 : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && Ho.test(String.fromCharCode(t)) : Qt(t, Pr);
  }
  function ze(t) {
    return t < 48 ? t === 36 : t < 58 ? true : t < 65 ? false : t <= 90 ? true : t < 97 ? t === 95 : t <= 122 ? true : t <= 65535 ? t >= 170 && zo.test(String.fromCharCode(t)) : Qt(t, Pr) || Qt(t, Vo);
  }
  var Zt = { keyword: ["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete"], strict: ["implements", "interface", "let", "package", "private", "protected", "public", "static", "yield"], strictBind: ["eval", "arguments"] }, Ko = new Set(Zt.keyword), Wo = new Set(Zt.strict), Go = new Set(Zt.strictBind);
  function Ar(t, r) {
    return r && t === "await" || t === "enum";
  }
  function Tr(t, r) {
    return Ar(t, r) || Wo.has(t);
  }
  function vr(t) {
    return Go.has(t);
  }
  ...
  var Ve = 0, Ke = 1, Ee = 2, es = 4, br = 8, xt = 16, Cr = 32, Be = 64, gt = 128, We = 256, Pt = Ke | Ee | gt | We, be = 1, Me = 2, Sr = 4, Ne = 8, At = 16, wr = 64, Tt = 128, ts = 256, ss = 512, rs = 1024, is = 2048, st = 4096, Ir = be | Me | Ne | Tt, _e = be | 0 | Ne | 0, vt = be | 0 | Sr | 0, Nr = be | 0 | At | 0, Zo = 0 | Me | 0 | Tt, el = 0 | Me | 0 | 0, kr = be | Me | Ne | ts, Dr = 0 | rs, ke = 0 | wr, tl = be | 0 | 0 | wr, sl = kr | ss, rl = 0 | rs, Fr = 0 | Me | 0 | st, il = is, Et = 4, as = 2, ns = 1, os = as | ns, al = as | Et, nl = ns | Et, ol = as, ll = ns, ls = 0, hs = class {
    constructor(t) {
    ...
    get inTopLevel() {
      return (this.currentScope().flags & Ke) > 0;
    }
    get inFunction() {
      return (this.currentVarScopeFlags() & Ee) > 0;
    }
    get allowSuper() {
    ...
    treatFunctionsAsVarInScope(t) {
      return !!(t.flags & (Ee | gt) || !this.parser.inModule && t.flags & Ke);
    }
    declareName(t, r, e) {
      let s = this.currentScope();
      if (r & Ne || r & At)
        this.checkRedeclarationInScope(s, t, r, e), r & At ? s.functions.add(t) : s.lexical.add(t), r & Ne && this.maybeExportDefined(s, t);
      else if (r & Sr)
        for (let i = this.scopeStack.length - 1; i >= 0 && (s = this.scopeStack[i], this.checkRedeclarationInScope(s, t, r, e), s.var.add(t), this.maybeExportDefined(s, t), !(s.flags & Pt)); --i)
          ;
      this.parser.inModule && s.flags & Ke && this.undefinedExports.delete(t);
    }
    maybeExportDefined(t, r) {
      this.parser.inModule && t.flags & Ke && this.undefinedExports.delete(r);
    }
    ...
    isRedeclaredInScope(t, r, e) {
      return e & be ? e & Ne ? t.lexical.has(r) || t.functions.has(r) || t.var.has(r) : e & At ? t.lexical.has(r) || !this.treatFunctionsAsVarInScope(t) && t.var.has(r) : t.lexical.has(r) && !(t.flags & br && t.lexical.values().next().value === r) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(r) : false;
    }
    checkLocalExport(t) {
  ...
  function it(t, r, e) {
    ...
    for (; s === null && i > 0; )
      s = r[--i];
    s === null || s.start > e.start ? rt(t, e.comments) : Lr(s, e.comments);
  }
  var fl = class extends cl {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        t.leadingNode !== null && Lr(t.leadingNode, r), t.trailingNode !== null && pl(t.trailingNode, r);
      else {
  ...
  var Br = class {
    ...
    clone(t) {
      let r = new Br(), e = Object.keys(this);
    ...
    return r >= 48 && r <= 57;
  }, Mr = { decBinOct: /* @__PURE__ */ new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: /* @__PURE__ */ new Set([46, 88, 95, 120]) }, Ct = { bin: (t) => t === 48 || t === 49, oct: (t) => t >= 48 && t <= 55, dec: (t) => t >= 48 && t <= 57, hex: (t) => t >= 48 && t <= 57 || t >= 65 && t <= 70 || t >= 97 && t <= 102 };
  function _r(t, r, e, s, i, a) {
    ...
    for (; ; ) {
      ...
      if (b === 92) {
        p += r.slice(x, e);
        let M = gl(r, e, s, i, t === "template", a);
        M.ch === null && !m ? m = { pos: e, lineStart: s, curLine: i } : p += M.ch, { pos: e, lineStart: s, curLine: i } = M, x = e;
      } else
...
`);
      ...
      case 120: {
        let p;
        return { code: p, pos: r } = fs(t, r, e, s, 2, false, n, a), o(p === null ? null : String.fromCharCode(p));
      }
      case 117: {
        let p;
        return { code: p, pos: r } = jr(t, r, e, s, n, a), o(p === null ? null : String.fromCodePoint(p));
      }
      case 116:
        return o("	");
      case 98:
  ...
  function fs(t, r, e, s, i, a, n, o) {
    let c = r, p;
    return { n: p, pos: r } = Rr(t, r, e, s, 16, i, a, false, o, !n), p === null && (n ? o.invalidEscapeSequence(c, e, s) : r = c - 1), { code: p, pos: r };
  }
  function Rr(t, r, e, s, i, a, n, o, c, p) {
    let m = r, x = i === 16 ? Mr.hex : Mr.decBinOct, P = i === 16 ? Ct.hex : i === 10 ? Ct.dec : i === 8 ? Ct.oct : Ct.bin, b = false, M = 0;
    for (let q = 0, te = a == null ? 1 / 0 : a; q < te; ++q) {
      let se = t.charCodeAt(r), Z;
      if (se === 95 && o !== "bail") {
        let ie = t.charCodeAt(r - 1), Ye = t.charCodeAt(r + 1);
        if (o) {
          if (Number.isNaN(Ye) || !P(Ye) || x.has(ie) || x.has(Ye)) {
            if (p)
              return { n: null, pos: r };
      ...
      if (se >= 97 ? Z = se - 97 + 10 : se >= 65 ? Z = se - 65 + 10 : yl(se) ? Z = se - 48 : Z = 1 / 0, Z >= i) {
        if (Z <= 9 && p)
          return { n: null, pos: r };
        if (Z <= 9 && c.invalidDigit(r, e, s, i))
          Z = 0;
        else if (n)
          Z = 0, b = true;
        else
    ...
    return r === m || a != null && r - m !== a || b ? { n: null, pos: r } : { n: M, pos: r };
  }
  ...
  var Tl = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), De = class {
    ...
    constructor(t, r) {
      super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = { invalidDigit: (e, s, i, a) => this.options.errorRecovery ? (this.raise(u.InvalidDigit, { at: nt(e, s, i), radix: a }), true) : false, numericSeparatorInEscapeSequence: this.errorBuilder(u.NumericSeparatorInEscapeSequence), unexpectedNumericSeparator: this.errorBuilder(u.UnexpectedNumericSeparator) }, this.errorHandlers_readCodePoint = Object.assign({}, this.errorHandlers_readInt, { invalidEscapeSequence: this.errorBuilder(u.InvalidEscapeSequence), invalidCodePoint: this.errorBuilder(u.InvalidCodePoint) }), this.errorHandlers_readStringContents_string = Object.assign({}, this.errorHandlers_readCodePoint, { strictNumericEscape: (e, s, i) => {
        ...
        throw this.raise(u.UnterminatedTemplate, { at: nt(e, s, i) });
      } }), this.state = new Br(), this.state.init(t), this.input = r, this.length = r.length, this.isLookahead = false;
    }
    pushToken(t) {
      this.tokens.length = this.state.tokensLength, this.tokens.push(t), ++this.state.tokensLength;
    }
    next() {
      this.checkKeywordEscapes(), this.options.tokens && this.pushToken(new De(this.state)), this.state.lastTokStart = this.state.start, this.state.lastTokEndLoc = this.state.endLoc, this.state.lastTokStartLoc = this.state.startLoc, this.nextToken();
    }
    eat(t) {
    ...
    skipBlockComment(t) {
      ...
      for (this.state.pos = s + t.length, bt.lastIndex = e + 2; bt.test(this.input) && bt.lastIndex <= s; )
        ++this.state.curLine, this.state.lineStart = bt.lastIndex;
      if (this.isLookahead)
        return;
    ...
    skipLineComment(t) {
      ...
      if (this.state.pos < this.length)
        for (; !at(s) && ++this.state.pos < this.length; )
    ...
    readToken_numberSign() {
      ...
      if (r === 123 || r === 91 && this.hasPlugin("recordAndTuple")) {
        ...
        ve(r) ? (++this.state.pos, this.finishToken(136, this.readWord1(r))) : r === 92 ? (++this.state.pos, this.finishToken(136, this.readWord1())) : this.finishOp(27, 1);
    }
    readToken_dot() {
    ...
    readToken_interpreter() {
      ...
      for (this.state.pos += 1; !at(t) && ++this.state.pos < this.length; )
    ...
    readInt(t, r) {
      let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, { n: i, pos: a } = Rr(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, r, e, s, this.errorHandlers_readInt, false);
    ...
    readRadixNumber(t) {
      ...
      if (ve(this.codePointAtPos(this.state.pos)))
    ...
    readCodePoint(t) {
      let { code: r, pos: e } = jr(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
      return this.state.pos = e, r;
    }
    readString(t) {
      let { str: r, pos: e, curLine: s, lineStart: i } = _r(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
    ...
    readTemplateToken() {
      let t = this.input[this.state.pos], { str: r, firstInvalidLoc: e, pos: s, curLine: i, lineStart: a } = _r("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
    ...
    readWord1(t) {
      ...
      for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length; ) {
        ...
        if (ze(i))
          ...
          let a = this.state.curPosition(), n = this.state.pos === e ? ve : ze;
    ...
    readWord(t) {
      let r = this.readWord1(t), e = oe.get(r);
      e !== void 0 ? this.finishToken(e, Ie(e)) : this.finishToken(130, r);
    }
    checkKeywordEscapes() {
      let { type: t } = this.state;
      Xt(t) && this.state.containsEsc && this.raise(u.InvalidEscapedReservedWord, { at: this.state.startLoc, reservedWord: Ie(t) });
    }
    raise(t, r) {
      let { at: e } = r, s = h(r, Pl), i = e instanceof f ? e : e.loc.start, a = t({ loc: i, details: s });
      if (!this.options.errorRecovery)
        throw a;
      return this.isLookahead || this.state.errors.push(a), a;
    }
    raiseOverwrite(t, r) {
      let { at: e } = r, s = h(r, Al), i = e instanceof f ? e : e.loc.start, a = i.index, n = this.state.errors;
    ...
    unexpected(t, r) {
      throw this.raise(u.UnexpectedToken, { expected: r ? Ie(r) : null, at: t != null ? t : this.state.startLoc });
    }
    expectPlugin(t, r) {
      if (this.hasPlugin(t))
        return true;
    ...
    declarePrivateName(t, r, e) {
      ...
      if (r & os) {
        let o = n && i.get(t);
        if (o) {
          let c = o & Et, p = r & Et, m = o & os, x = r & os;
    ...
    constructor(t) {
      this.parser = void 0, this.stack = [new St()], this.parser = t;
    }
    enter(t) {
      this.stack.push(t);
    }
    ...
    recordAsyncArrowParametersError(t) {
      ...
      for (; i.canBeArrowParameterDeclaration(); )
        i.type === ds && i.recordDeclarationError(u.AwaitBindingIdentifier, { at: r }), i = e[--s];
    }
    validateAsPattern() {
  ...
  var Ge = 0, zr = 1, wt = 2, Vr = 4, Je = 8, kl = class {
    constructor() {
      this.stacks = [];
    }
    enter(t) {
    ...
    get hasIn() {
      return (this.currentFlags() & Je) > 0;
    }
  };
  function It(t, r) {
    return (t ? wt : 0) | (r ? zr : 0);
  }
  var Dl = class extends vl {
    ...
    enterInitialScopes() {
      let t = Ge;
      this.inModule && (t |= wt), this.scope.enter(Ke), this.prodParam.enter(t);
    }
  ...
  ms.__clone = function() {
    let t = new kt(void 0, this.start, this.loc.start), r = Object.keys(this);
  ...
  function Ce(t) {
    let { type: r, start: e, end: s, loc: i, range: a, extra: n, name: o } = t, c = Object.create(ms);
  ...
  var Ol = class extends Dl {
    startNode() {
      return new kt(this, this.state.start, this.state.startLoc);
    }
    startNodeAt(t) {
      return new kt(this, t.index, t);
    }
    startNodeAtNode(t) {
  ...
  var jl = /\*?\s*@((?:no)?flow)\b/, ql = (t) => class extends t {
    ...
    flowParsePredicate() {
      ...
      return this.next(), this.expectContextual(108), this.state.lastTokStart > s.index + 1 && this.raise(F.UnexpectedSpaceBetweenModuloChecks, { at: s }), this.eat(10) ? (e.value = super.parseExpression(), this.expect(11), this.finishNode(e, "DeclaredPredicate")) : this.finishNode(e, "InferredPredicate");
    }
    ...
    flowParseDeclareVariable(e) {
      return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(true), this.scope.declareName(e.id.name, vt, e.id.loc.start), this.semicolon(), this.finishNode(e, "DeclareVariable");
    }
    flowParseDeclareModule(e) {
      this.scope.enter(Ve), this.match(131) ? e.id = super.parseExprAtom() : e.id = this.parseIdentifier();
      let s = e.body = this.startNode(), i = s.body = [];
      for (this.expect(5); !this.match(8); ) {
        let o = this.startNode();
        this.match(83) ? (this.next(), !this.isContextual(128) && !this.match(87) && this.raise(F.InvalidNonTypeImportInDeclareModule, { at: this.state.lastTokStartLoc }), super.parseImport(o)) : (this.expectContextual(123, F.UnsupportedStatementInDeclareModule), o = this.flowParseDeclare(o, true)), i.push(o);
      }
      this.scope.exit(), this.expect(8), this.finishNode(s, "BlockStatement");
      let a = null, n = false;
      return i.forEach((o) => {
        Ml(o) ? (a === "CommonJS" && this.raise(F.AmbiguousDeclareModuleKind, { at: o }), a = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(F.DuplicateDeclareModuleExports, { at: o }), a === "ES" && this.raise(F.AmbiguousDeclareModuleKind, { at: o }), a = "CommonJS", n = true);
    ...
    flowParseDeclareExportDeclaration(e, s) {
      ...
      if (this.match(75) || this.isLet() || (this.isContextual(128) || this.isContextual(127)) && !s) {
        ...
        throw this.raise(F.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: i, suggestion: _l[i] });
      }
    ...
    flowParseInterfaceish(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      if (e.id = this.flowParseRestrictedIdentifier(!s, true), this.scope.declareName(e.id.name, s ? Nr : _e, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81))
        do
    ...
    checkReservedType(e, s, i) {
      Bl.has(e) && this.raise(i ? F.AssignReservedType : F.UnexpectedReservedType, { at: s, reservedType: e });
    }
    ...
    flowParseTypeAlias(e) {
      return e.id = this.flowParseRestrictedIdentifier(false, true), this.scope.declareName(e.id.name, _e, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(29), this.semicolon(), this.finishNode(e, "TypeAlias");
    }
    flowParseOpaqueType(e, s) {
      return this.expectContextual(128), e.id = this.flowParseRestrictedIdentifier(true, true), this.scope.declareName(e.id.name, _e, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(14) && (e.supertype = this.flowParseTypeInitialiser(14)), e.impltype = null, s || (e.impltype = this.flowParseTypeInitialiser(29)), this.semicolon(), this.finishNode(e, "OpaqueType");
    }
    flowParseTypeParameter() {
      ...
      return i.name = n.name, i.variance = a, i.bound = n.typeAnnotation, this.match(29) ? (this.eat(29), i.default = this.flowParseType()) : e && this.raise(F.MissingTypeParamDefault, { at: s }), this.finishNode(i, "TypeParameter");
    }
    ...
    flowParseObjectType(e) {
      ...
      for (i && this.match(6) ? (this.expect(6), m = 9, x = true) : (this.expect(5), m = 8, x = false), p.exact = x; !this.match(m); ) {
        let M = false, q = null, te = null, se = this.startNode();
        if (n && this.isContextual(116)) {
          let ie = this.lookahead();
          ie.type !== 14 && ie.type !== 17 && (this.next(), q = this.state.startLoc, s = false);
        }
        if (s && this.isContextual(104)) {
          let ie = this.lookahead();
          ie.type !== 14 && ie.type !== 17 && (this.next(), M = true);
        }
        let Z = this.flowParseVariance();
        if (this.eat(0))
          q != null && this.unexpected(q), this.eat(0) ? (Z && this.unexpected(Z.loc.start), p.internalSlots.push(this.flowParseObjectTypeInternalSlot(se, M))) : p.indexers.push(this.flowParseObjectTypeIndexer(se, M, Z));
        else if (this.match(10) || this.match(47))
          q != null && this.unexpected(q), Z && this.unexpected(Z.loc.start), p.callProperties.push(this.flowParseObjectTypeCallProperty(se, M));
        else {
          let ie = "init";
          if (this.isContextual(98) || this.isContextual(103)) {
            let mh = this.lookahead();
            yr(mh.type) && (ie = this.state.value, this.next());
          }
          let Ye = this.flowParseObjectTypeProperty(se, M, q, Z, ie, a, o != null ? o : !x);
          Ye === null ? (P = true, te = this.state.lastTokStartLoc) : p.properties.push(Ye);
        }
        this.flowObjectTypeSemicolon(), te && !this.match(8) && !this.match(9) && this.raise(F.UnexpectedExplicitInexactInObject, { at: te });
      }
    ...
    flowParseObjectTypeProperty(e, s, i, a, n, o, c) {
      if (this.eat(21))
        return this.match(12) || this.match(13) || this.match(8) || this.match(9) ? (o ? c || this.raise(F.InexactInsideExact, { at: this.state.lastTokStartLoc }) : this.raise(F.InexactInsideNonObject, { at: this.state.lastTokStartLoc }), a && this.raise(F.InexactVariance, { at: a }), null) : (o || this.raise(F.UnexpectedSpreadType, { at: this.state.lastTokStartLoc }), i != null && this.unexpected(i), a && this.raise(F.SpreadVariance, { at: a }), e.argument = this.flowParseType(), this.finishNode(e, "ObjectTypeSpreadProperty"));
      {
        e.key = this.flowParseObjectPropertyKey(), e.static = s, e.proto = i != null, e.kind = n;
        let p = false;
        return this.match(47) || this.match(10) ? (e.method = true, i != null && this.unexpected(i), a && this.unexpected(a.loc.start), e.value = this.flowParseObjectTypeMethodish(this.startNodeAt(e.loc.start)), (n === "get" || n === "set") && this.flowCheckGetterSetterParams(e), !o && e.key.name === "constructor" && e.value.this && this.raise(F.ThisParamBannedInConstructor, { at: e.value.this })) : (n !== "init" && this.unexpected(), e.method = false, this.eat(17) && (p = true), e.value = this.flowParseTypeInitialiser(), e.variance = a), e.optional = p, this.finishNode(e, "ObjectTypeProperty");
      }
    }
    flowCheckGetterSetterParams(e) {
      let s = e.kind === "get" ? 0 : 1, i = e.value.params.length + (e.value.rest ? 1 : 0);
      e.value.this && this.raise(e.kind === "get" ? F.GetterMayNotHaveThisParam : F.SetterMayNotHaveThisParam, { at: e.value.this }), i !== s && this.raise(e.kind === "get" ? u.BadGetterArity : u.BadSetterArity, { at: e }), e.kind === "set" && e.value.rest && this.raise(u.BadSetterRestParameter, { at: e });
    }
    ...
    flowParseFunctionTypeParam(e) {
      ...
      return o.type === 14 || o.type === 17 ? (c && !e && this.raise(F.ThisParamMustBeFirst, { at: n }), s = this.parseIdentifier(c), this.eat(17) && (i = true, c && this.raise(F.ThisParamMayNotBeOptional, { at: n })), a = this.flowParseTypeInitialiser()) : a = this.flowParseType(), n.name = s, n.optional = i, n.typeAnnotation = a, this.finishNode(n, "FunctionTypeParam");
    }
    ...
    shouldParseExportDeclaration() {
      ...
      return xr(e) || this.shouldParseEnums() && e === 124 ? !this.state.containsEsc : super.shouldParseExportDeclaration();
    }
    isExportDefaultSpecifier() {
      let { type: e } = this.state;
      return xr(e) || this.shouldParseEnums() && e === 124 ? this.state.containsEsc : super.isExportDefaultSpecifier();
    }
    ...
    parseConditional(e, s, i) {
      ...
      if (p || x.length > 0) {
        ...
        p && m.length > 1 && this.raise(F.AmbiguousConditionalArrow, { at: a.startLoc }), p && m.length === 1 && (this.state = a, P.push(m[0].start), this.state.noArrowAt = P, { consequent: c, failed: p } = this.tryParseConditionalConsequent());
      }
    ...
    finishArrowValidation(e) {
      var s;
      this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, false), this.scope.enter(Ee | es), super.checkParams(e, false, true), this.scope.exit();
    }
    ...
    parseClassMember(e, s, i) {
      ...
      super.parseClassMember(e, s, i), s.declare && (s.type !== "ClassProperty" && s.type !== "ClassPrivateProperty" && s.type !== "PropertyDefinition" ? this.raise(F.DeclareClassElement, { at: a }) : s.value && this.raise(F.DeclareClassFieldInitializer, { at: s.value }));
    }
    isIterator(e) {
    ...
    getTokenFromCode(e) {
      ...
      return e === 123 && s === 124 ? this.finishOp(6, 2) : this.state.inType && (e === 62 || e === 60) ? this.finishOp(e === 62 ? 48 : 47, 1) : this.state.inType && e === 63 ? s === 46 ? this.finishOp(18, 2) : this.finishOp(17, 1) : Xo(e, s, this.input.charCodeAt(this.state.pos + 2)) ? (this.state.pos += 2, this.readIterator()) : super.getTokenFromCode(e);
    }
    isAssignable(e, s) {
    ...
    toReferencedList(e, s) {
      for (let a = 0; a < e.length; a++) {
        var i;
        let n = e[a];
        n && n.type === "TypeCastExpression" && !((i = n.extra) != null && i.parenthesized) && (e.length > 1 || !s) && this.raise(F.TypeCastInPattern, { at: n.typeAnnotation });
      }
      return e;
    }
    ...
    pushClassMethod(e, s, i, a, n, o) {
      if (s.variance && this.unexpected(s.variance.loc.start), delete s.variance, this.match(47) && (s.typeParameters = this.flowParseTypeParameterDeclaration()), super.pushClassMethod(e, s, i, a, n, o), s.params && n) {
        let c = s.params;
        c.length > 0 && this.isThisParam(c[0]) && this.raise(F.ThisParamBannedInConstructor, { at: s });
    ...
    checkGetterSetterParams(e) {
      ...
      if (s.length > 0) {
        let i = s[0];
        this.isThisParam(i) && e.kind === "get" ? this.raise(F.GetterMayNotHaveThisParam, { at: i }) : this.isThisParam(i) && this.raise(F.SetterMayNotHaveThisParam, { at: i });
      }
    }
    ...
    shouldParseDefaultImport(e) {
      return ys(e) ? Kr(this.state.type) : super.shouldParseDefaultImport(e);
    }
    checkImportReflection(e) {
      super.checkImportReflection(e), e.module && e.importKind !== "value" && this.raise(F.ImportReflectionHasImportType, { at: e.specifiers[0].loc.start });
    }
    ...
    maybeParseDefaultImportSpecifier(e) {
      ...
      if (this.match(87) ? s = "typeof" : this.isContextual(128) && (s = "type"), s) {
        ...
        s === "type" && a === 55 && this.unexpected(null, i.type), (Kr(a) || a === 5 || a === 55) && (this.next(), e.importKind = s);
      }
    ...
    parseImportSpecifier(e, s, i, a, n) {
      ...
      if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
        ...
        c !== null && !Ae(this.state.type) ? (e.imported = x, e.importKind = c, e.local = Ce(x)) : (e.imported = o, e.importKind = null, e.local = this.parseIdentifier());
      } else {
        if (c !== null && Ae(this.state.type))
        ...
        this.eatContextual(93) ? e.local = this.parseIdentifier() : (p = true, e.local = Ce(e.imported));
      }
      let m = ys(e);
      return i && m && this.raise(F.ImportTypeShorthandOnlyInPureImport, { at: e }), (i || m) && this.checkReservedType(e.local.name, e.local.loc.start, true), p && !i && !m && this.checkReservedWord(e.local.name, e.loc.start, true, true), this.finishImportSpecifier(e, "ImportSpecifier");
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
    ...
    parseMaybeAssign(e, s) {
      ...
      if ((i = n) != null && i.error || this.match(47)) {
        ...
        let p, m = this.tryParse((P) => {
          ...
          let M = this.forwardNoArrowParamsConversionAt(p, () => {
            let te = super.parseMaybeAssign(e, s);
            return this.resetStartLocationFromNode(te, p), te;
          });
          (b = M.extra) != null && b.parenthesized && P();
          let q = this.maybeUnwrapTypeCastExpression(M);
          return q.type !== "ArrowFunctionExpression" && P(), q.typeParameters = p, this.resetStartLocationFromNode(q, p), M;
        }, a), x = null;
        if (m.node && this.maybeUnwrapTypeCastExpression(m.node).type === "ArrowFunctionExpression") {
          if (!m.error && !m.aborted)
            return m.node.async && this.raise(F.UnexpectedTypeParameterBeforeAsyncArrowFunction, { at: p }), m.node;
          x = m.node;
        }
        if ((o = n) != null && o.node)
        ...
        throw (c = n) != null && c.thrown ? n.error : m.thrown ? m.error : this.raise(F.UnexpectedTokenAfterTypeParameter, { at: p });
      }
    ...
    checkParams(e, s, i) {
      ...
      if (!(i && this.state.noArrowParamsConversionAt.indexOf(e.start) !== -1)) {
        for (let n = 0; n < e.params.length; n++)
          this.isThisParam(e.params[n]) && n > 0 && this.raise(F.ThisParamMustBeFirst, { at: e.params[n] });
    ...
    parseTopLevel(e, s) {
      ...
      return this.state.hasFlowComment && this.raise(F.UnterminatedFlowComment, { at: this.state.curPosition() }), i;
    }
    skipBlockComment() {
    ...
    flowEnumErrorBooleanMemberNotInitialized(e, s) {
      ...
      this.raise(F.EnumBooleanMemberNotInitialized, { at: e, memberName: a, enumName: i });
    }
    ...
    flowEnumErrorNumberMemberNotInitialized(e, s) {
      let { enumName: i, memberName: a } = s;
      this.raise(F.EnumNumberMemberNotInitialized, { at: e, enumName: i, memberName: a });
    }
    flowEnumErrorStringMemberInconsistentlyInitailized(e, s) {
      let { enumName: i } = s;
      this.raise(F.EnumStringMemberInconsistentlyInitailized, { at: e, enumName: i });
    }
    flowEnumMemberInit() {
    ...
    flowEnumMembers(e) {
      ...
      for (; !this.match(8); ) {
        ...
        if (x === "")
          continue;
        /^[a-z]/.test(x) && this.raise(F.EnumInvalidMemberName, { at: p, memberName: x, suggestion: x[0].toUpperCase() + x.slice(1), enumName: s }), a.has(x) && this.raise(F.EnumDuplicateMemberName, { at: p, memberName: x, enumName: s }), a.add(x);
    ...
    flowEnumParseExplicitType(e) {
      ...
      return this.next(), i !== "boolean" && i !== "number" && i !== "string" && i !== "symbol" && this.raise(F.EnumInvalidExplicitType, { at: this.state.startLoc, enumName: s, invalidEnumType: i }), i;
    }
    flowEnumBody(e, s) {
      ...
      switch (e.hasUnknownMembers = c, n) {
        ...
        default: {
          ...
          if (!x && !P && m >= b) {
            ...
            return this.raise(F.EnumInconsistentMemberValues, { at: a, enumName: i }), p();
        }
      }
    }
  ...
  function Xe(t) {
    ...
    if (t.type === "JSXMemberExpression")
      return Xe(t.object) + "." + Xe(t.property);
  ...
  var $l = (t) => class extends t {
    jsxReadToken() {
      ...
      for (; ; ) {
        if (this.state.pos >= this.length)
          throw this.raise(Re.UnterminatedJsxContent, { at: this.state.startLoc });
        let i = this.input.charCodeAt(this.state.pos);
        switch (i) {
          case 60:
          case 123:
          ...
          case 125:
          default:
            at(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(true), s = this.state.pos) : ++this.state.pos;
        }
      }
    }
    jsxReadNewLine(e) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
    ...
    jsxReadString(e) {
      ...
      for (; ; ) {
        ...
        if (a === e)
          break;
        a === 38 ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadEntity(), i = this.state.pos) : at(a) ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadNewLine(false), i = this.state.pos) : ++this.state.pos;
      }
    ...
    jsxParseIdentifier() {
      let e = this.startNode();
      return this.match(138) ? e.name = this.state.value : Xt(this.state.type) ? e.name = Ie(this.state.type) : this.unexpected(), this.next(), this.finishNode(e, "JSXIdentifier");
    }
    ...
    jsxParseAttributeValue() {
      ...
      switch (this.state.type) {
        case 5:
          return e = this.startNode(), this.setContext(U.brace), this.next(), e = this.jsxParseExpressionContainer(e, U.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(Re.AttributeIsEmpty, { at: e }), e;
        case 140:
        case 131:
          return this.parseExprAtom();
        default:
          throw this.raise(Re.UnsupportedJsxValue, { at: this.state.startLoc });
      }
    }
    ...
    jsxParseSpreadChild(e) {
      return this.next(), e.expression = this.parseExpression(), this.setContext(U.j_expr), this.state.canStartJSXElement = true, this.expect(8), this.finishNode(e, "JSXSpreadChild");
    }
        ...
        e:
          for (; ; )
            switch (this.state.type) {
              ...
              case 5: {
                let o = this.startNode();
                this.setContext(U.brace), this.next(), this.match(21) ? i.push(this.jsxParseSpreadChild(o)) : i.push(this.jsxParseExpressionContainer(o, U.j_expr));
                break;
              }
              default:
                throw this.unexpected();
            }
        Fe(a) && !Fe(n) && n !== null ? this.raise(Re.MissingClosingTagFragment, { at: n }) : !Fe(a) && Fe(n) ? this.raise(Re.MissingClosingTagElement, { at: n, openingTagName: Xe(a.name) }) : !Fe(a) && !Fe(n) && Xe(n.name) !== Xe(a.name) && this.raise(Re.MissingClosingTagElement, { at: n, openingTagName: Xe(a.name) });
      }
      if (Fe(a) ? (s.openingFragment = a, s.closingFragment = n) : (s.openingElement = a, s.closingElement = n), s.children = i, this.match(47))
        throw this.raise(Re.UnwrappedAdjacentJSXElements, { at: this.state.startLoc });
      return Fe(a) ? this.finishNode(s, "JSXFragment") : this.finishNode(s, "JSXElement");
    }
    jsxParseElement() {
    ...
    updateContext(e) {
      ...
      if (i === 56 && e === 140)
        s.splice(-2, 2, U.j_cTag), this.state.canStartJSXElement = false;
      else if (i === 140)
        s.push(U.j_oTag);
      else if (i === 141) {
        let a = s[s.length - 1];
        a === U.j_oTag && e === 56 || a === U.j_cTag ? (s.pop(), this.state.canStartJSXElement = s[s.length - 1] === U.j_expr) : (this.setContext(U.j_expr), this.state.canStartJSXElement = true);
      } else
        this.state.canStartJSXElement = Oo(i);
    }
  }, Hl = class extends hs {
    constructor() {
    ...
    enter(t) {
      t == We && this.importsStack.push(/* @__PURE__ */ new Set()), super.enter(t);
    }
    exit() {
      let t = super.exit();
      return t == We && this.importsStack.pop(), t;
    }
    hasImport(t, r) {
    ...
    declareName(t, r, e) {
      ...
      super.declareName(t, r, e), r & Me && (r & be || (this.checkRedeclarationInScope(s, t, r, e), this.maybeExportDefined(s, t)), s.types.add(t)), r & ts && s.enums.add(t), r & ss && s.constEnums.add(t), r & Tt && s.classes.add(t);
    }
    isRedeclaredInScope(t, r, e) {
      if (t.enums.has(r)) {
        if (e & ts) {
      ...
      return e & Tt && t.classes.has(r) ? t.lexical.has(r) ? !!(e & be) : false : e & Me && t.types.has(r) ? true : super.isRedeclaredInScope(t, r, e);
    }
    checkLocalExport(t) {
      let { name: r } = t;
      if (this.hasImport(r))
  ...
  }, Vl = (t, r) => Object.hasOwnProperty.call(t, r) && t[r];
  function Kl(t) {
    if (t == null)
  ...
  var Jl = (t) => class extends t {
    ...
    tsParseModifiers(e) {
      let { modified: s, allowedModifiers: i, disallowedModifiers: a, stopOnStartOfClassStaticBlock: n, errorTemplate: o = w.InvalidModifierOnTypeMember } = e, c = (m, x, P, b) => {
      ...
      for (; ; ) {
        ...
        if (!x)
          break;
        Gr(x) ? s.accessibility ? this.raise(w.DuplicateAccessibilityModifier, { at: m, modifier: x }) : (c(m, x, x, "override"), c(m, x, x, "static"), c(m, x, x, "readonly"), s.accessibility = x) : Gl(x) ? (s[x] && this.raise(w.DuplicateModifier, { at: m, modifier: x }), s[x] = true, c(m, x, "in", "out")) : (Object.hasOwnProperty.call(s, x) ? this.raise(w.DuplicateModifier, { at: m, modifier: x }) : (c(m, x, "static", "readonly"), c(m, x, "static", "override"), c(m, x, "override", "readonly"), c(m, x, "abstract", "override"), p(m, x, "declare", "override"), p(m, x, "static", "abstract")), s[x] = true), a != null && a.includes(x) && this.raise(o, { at: m, modifier: x });
      }
    }
    ...
    tsParseDelimitedList(e, s, i) {
      return Kl(this.tsParseDelimitedListWorker(e, s, true, i));
    }
    ...
    tsParseNonArrayType() {
      switch (this.state.type) {
        ...
        default: {
          let { type: e } = this.state;
          if (z(e) || e === 88 || e === 84) {
            let s = e === 88 ? "TSVoidKeyword" : e === 84 ? "TSNullKeyword" : Wl(this.state.value);
    ...
    tsParseInterfaceDeclaration(e) {
      ...
      if (this.hasFollowingLineBreak())
        return null;
      this.expectContextual(127), s.declare && (e.declare = true), z(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Zo)) : (e.id = null, this.raise(w.MissingInterfaceName, { at: this.state.startLoc })), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutModifiers.bind(this)), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
      let i = this.startNode();
    ...
    tsParseEnumDeclaration(e) {
      let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      return s.const && (e.const = true), s.declare && (e.declare = true), this.expectContextual(124), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? sl : kr), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration");
    }
    tsParseModuleBlock() {
      let e = this.startNode();
      return this.scope.enter(Ve), this.expect(5), super.parseBlockOrModuleBlockBody(e.body = [], void 0, true, 8), this.scope.exit(), this.finishNode(e, "TSModuleBlock");
    }
    tsParseModuleOrNamespaceDeclaration(e) {
      ...
      if (e.id = this.parseIdentifier(), s || this.checkIdentifier(e.id, rl), this.eat(16)) {
        ...
        this.scope.enter(We), this.prodParam.enter(Ge), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
    ...
    tsParseImportEqualsDeclaration(e, s) {
      e.isExport = s || false, e.id = this.parseIdentifier(), this.checkIdentifier(e.id, st), this.expect(29);
    ...
    tsParseExpressionStatement(e, s, i) {
      switch (s.name) {
        ...
        case "global":
          if (this.match(5)) {
            this.scope.enter(We), this.prodParam.enter(Ge);
            let a = e;
    ...
    registerFunctionStatementId(e) {
      !e.body && e.id ? this.checkIdentifier(e.id, Dr) : super.registerFunctionStatementId(e);
    }
    ...
    parseSubscript(e, s, i, a) {
      ...
      if (this.match(47) || this.match(51)) {
        let o, c = this.tsTryParseAndCatch(() => {
          ...
          if (m === 48 || m === 52 || m !== 10 && Jt(m) && !this.hasPrecedingLineBreak())
            return;
    ...
    parseExprOp(e, s, i) {
      let a;
      if (mt(58) > i && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (a = this.isContextual(118)))) {
        let n = this.startNodeAt(s);
    ...
    parseVarStatement(e, s) {
      ...
      for (let { id: o, init: c } of n.declarations)
        c && (s !== "const" || o.typeAnnotation ? this.raise(w.InitializerNotAllowedInAmbientContext, { at: c }) : c.type !== "StringLiteral" && c.type !== "BooleanLiteral" && c.type !== "NumericLiteral" && c.type !== "BigIntLiteral" && (c.type !== "TemplateLiteral" || c.expressions.length > 0) && !Xl(c) && this.raise(w.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, { at: c }));
      return n;
    }
    ...
    parseClassId(e, s, i, a) {
      if ((!s || i) && this.isContextual(111))
        return;
      super.parseClassId(e, s, i, e.declare ? Dr : Ir);
    ...
    parseMaybeAssign(e, s) {
      ...
      if (this.hasPlugin("jsx") && (this.match(140) || this.match(47))) {
        if (x = this.state.clone(), P = this.tryParse(() => super.parseMaybeAssign(e, s), x), !P.error)
          return P.node;
        let { context: te } = this.state, se = te[te.length - 1];
        (se === U.j_oTag || se === U.j_expr) && te.pop();
      }
      if (!((i = P) != null && i.error) && !this.match(47))
        return super.parseMaybeAssign(e, s);
      (!x || x === this.state) && (x = this.state.clone());
      let M, q = this.tryParse((te) => {
        var se, Z;
        M = this.tsParseTypeParameters();
        let ie = super.parseMaybeAssign(e, s);
        return (ie.type !== "ArrowFunctionExpression" || (se = ie.extra) != null && se.parenthesized) && te(), ((Z = M) == null ? void 0 : Z.params.length) !== 0 && this.resetStartLocationFromNode(ie, M), ie.typeParameters = M, ie;
      }, x);
      if (!q.error && !q.aborted)
        return M && this.reportReservedArrowTypeParam(M), q.node;
      if (!P && (Wr(!this.hasPlugin("jsx")), b = this.tryParse(() => super.parseMaybeAssign(e, s), x), !b.error))
        return b.node;
      if ((a = P) != null && a.node)
        return this.state = P.failState, P.node;
      if (q.node)
        return this.state = q.failState, M && this.reportReservedArrowTypeParam(M), q.node;
      if ((n = b) != null && n.node)
        return this.state = b.failState, b.node;
      throw (o = P) != null && o.thrown ? P.error : q.thrown ? q.error : (c = b) != null && c.thrown ? b.error : ((p = P) == null ? void 0 : p.error) || q.error || ((m = b) == null ? void 0 : m.error);
    }
    ...
    isValidLVal(e, s, i) {
      return Vl({ TSTypeCastExpression: true, TSParameterProperty: "parameter", TSNonNullExpression: "expression", TSAsExpression: (i !== ke || !s) && ["expression", true], TSSatisfiesExpression: (i !== ke || !s) && ["expression", true], TSTypeAssertion: (i !== ke || !s) && ["expression", true] }, e) || super.isValidLVal(e, s, i);
    }
    parseBindingAtom() {
      switch (this.state.type) {
        case 78:
    ...
    parseImportSpecifier(e, s, i, a, n) {
      return !s && a ? (this.parseTypeOnlyImportExportSpecifier(e, true, i), this.finishNode(e, "ImportSpecifier")) : (e.importKind = "value", super.parseImportSpecifier(e, s, i, a, i ? Fr : st));
    }
    parseTypeOnlyImportExportSpecifier(e, s, i) {
      ...
      if (this.isContextual(93)) {
        ...
        if (this.isContextual(93)) {
          ...
          Ae(this.state.type) ? (p = true, o = b, c = s ? this.parseIdentifier() : this.parseModuleExportName(), m = false) : (c = M, m = false);
        } else
          Ae(this.state.type) ? (m = false, c = s ? this.parseIdentifier() : this.parseModuleExportName()) : (p = true, o = b);
      } else
        Ae(this.state.type) && (p = true, s ? (o = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, true, true)) : o = this.parseModuleExportName());
      ...
      e[P] = p ? "type" : "value", m && this.eatContextual(93) && (e[n] = s ? this.parseIdentifier() : this.parseModuleExportName()), e[n] || (e[n] = Ce(e[a])), s && this.checkIdentifier(e[n], p ? Fr : st);
    }
  };
  function Xl(t) {
    ...
    return r && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? false : Jr(t.object);
  }
  function Jr(t) {
    return t.type === "Identifier" ? true : t.type !== "MemberExpression" || t.computed ? false : Jr(t.object);
  }
  var Xr = _`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), Yl = (t) => class extends t {
    parsePlaceholder(e) {
      if (this.match(142)) {
        let s = this.startNode();
    ...
    parseClass(e, s, i) {
      ...
      if (o)
        if (this.match(81) || this.match(142) || this.match(5))
          ...
          throw this.raise(Xr.ClassNameIsRequired, { at: this.state.startLoc });
        }
      else
    ...
    isExportDefaultSpecifier() {
      if (this.match(65)) {
        let e = this.nextTokenStart();
        if (this.isUnparsedContextual(e, "from") && this.input.startsWith(Ie(142), this.nextTokenStartSince(e + 4)))
          return true;
      }
    ...
    assertNoSpace() {
      this.state.start > this.state.lastTokEndLoc.index && this.raise(Xr.UnexpectedSpace, { at: this.state.lastTokEndLoc });
    }
  }, Ql = (t) => class extends t {
    parseV8Intrinsic() {
      if (this.match(54)) {
  ...
  var Yr = ["minimal", "fsharp", "hack", "smart"], Qr = ["^^", "@@", "^", "%", "#"], Zr = ["hash", "bar"];
  function Zl(t) {
    if (re(t, "decorators")) {
      if (re(t, "decorators-legacy"))
        throw new Error("Cannot use the decorators and decorators-legacy plugin together");
      let r = je(t, "decorators", "decoratorsBeforeExport");
      if (r != null && typeof r != "boolean")
        throw new Error("'decoratorsBeforeExport' must be a boolean.");
      let e = je(t, "decorators", "allowCallParenthesized");
      if (e != null && typeof e != "boolean")
        throw new Error("'allowCallParenthesized' must be a boolean.");
    }
    if (re(t, "flow") && re(t, "typescript"))
      throw new Error("Cannot combine flow and typescript plugins.");
    if (re(t, "placeholders") && re(t, "v8intrinsic"))
      throw new Error("Cannot combine placeholders and v8intrinsic plugins.");
    if (re(t, "pipelineOperator")) {
      let r = je(t, "pipelineOperator", "proposal");
      if (!Yr.includes(r)) {
        let s = Yr.map((i) => `"${i}"`).join(", ");
        throw new Error(`"pipelineOperator" requires "proposal" option whose value must be one of: ${s}.`);
      }
      let e = re(t, ["recordAndTuple", { syntaxType: "hash" }]);
      if (r === "hack") {
        if (re(t, "placeholders"))
          throw new Error("Cannot combine placeholders plugin and Hack-style pipes.");
        if (re(t, "v8intrinsic"))
          throw new Error("Cannot combine v8intrinsic plugin and Hack-style pipes.");
        let s = je(t, "pipelineOperator", "topicToken");
        if (!Qr.includes(s)) {
          let i = Qr.map((a) => `"${a}"`).join(", ");
    ...
    if (re(t, "moduleAttributes")) {
      if (re(t, "importAssertions"))
        throw new Error("Cannot combine importAssertions and moduleAttributes plugins.");
      if (je(t, "moduleAttributes", "version") !== "may-2020")
        throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.");
    }
    if (re(t, "recordAndTuple") && je(t, "recordAndTuple", "syntaxType") != null && !Zr.includes(je(t, "recordAndTuple", "syntaxType")))
      throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Zr.map((r) => `'${r}'`).join(", "));
    if (re(t, "asyncDoExpressions") && !re(t, "doExpressions")) {
  ...
  function th(t) {
    let r = {};
    for (let e of Object.keys(ti))
      r[e] = t && t[e] != null ? t[e] : ti[e];
    return r;
  }
  var sh = (t, r) => Object.hasOwnProperty.call(t, r) && t[r], si = (t) => t.type === "ParenthesizedExpression" ? si(t.expression) : t, rh = class extends Ol {
    toAssignable(t) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
      var e, s;
      let i;
      switch ((t.type === "ParenthesizedExpression" || (e = t.extra) != null && e.parenthesized) && (i = si(t), r ? i.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(u.InvalidParenthesizedAssignment, { at: t }) : i.type !== "MemberExpression" && this.raise(u.InvalidParenthesizedAssignment, { at: t }) : this.raise(u.InvalidParenthesizedAssignment, { at: t })), t.type) {
        case "Identifier":
        case "ObjectPattern":
        case "ArrayPattern":
    ...
    isValidLVal(t, r, e) {
      return sh({ AssignmentPattern: "left", RestElement: "argument", ObjectProperty: "value", ParenthesizedExpression: "expression", ArrayPattern: "elements", ObjectPattern: "properties" }, t);
    }
    checkLVal(t, r) {
      let { in: e, binding: s = ke, checkClashes: i = false, strictModeChanged: a = false, allowingSloppyLetBinding: n = !(s & Ne), hasParenthesizedAncestor: o = false } = r;
      var c;
      let p = t.type;
      if (this.isObjectMethod(t))
        return;
      if (p === "MemberExpression") {
        s !== ke && this.raise(u.InvalidPropertyBindingPattern, { at: t });
        return;
      }
      ...
      if (m === true)
        return;
      if (m === false) {
        let M = s === ke ? u.InvalidLhs : u.InvalidLhsBinding;
        this.raise(M, { at: t, ancestor: e.type === "UpdateExpression" ? { type: "UpdateExpression", prefix: e.prefix } : { type: e.type } });
        return;
      }
      ...
      for (let M of [].concat(t[x]))
        M && this.checkLVal(M, { in: b, binding: s, checkClashes: i, allowingSloppyLetBinding: n, strictModeChanged: a, hasParenthesizedAncestor: P });
    }
    checkIdentifier(t, r) {
      let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !(r & Ne);
      this.state.strict && (e ? Er(t.name, this.inModule) : vr(t.name)) && (r === ke ? this.raise(u.StrictEvalArguments, { at: t, referenceName: t.name }) : this.raise(u.StrictEvalArgumentsBinding, { at: t, bindingName: t.name })), !s && t.name === "let" && this.raise(u.LetInLexicalBinding, { at: t }), r & ke || this.declareNameFromIdentifier(t, r);
    }
    ...
    parseExprOp(t, r, e) {
      if (this.isPrivateName(t)) {
        ...
        (e >= mt(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(u.PrivateInExpectedIn, { at: t, identifierName: i }), this.classScope.usePrivateName(i, t.loc.start);
      }
      ...
      if (_o(s) && (this.prodParam.hasIn || !this.match(58))) {
        ...
        if (i > e) {
          ...
          if (o && (i = mt(42)), this.next(), s === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
    ...
    parseHackPipeBody() {
      ...
      return R.has(e.type) && !((t = e.extra) != null && t.parenthesized) && this.raise(u.PipeUnparenthesizedBody, { at: r, type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(u.PipeTopicUnused, { at: r }), e;
    }
    ...
    parseMaybeUnary(t, r) {
      ...
      if (s) {
        ...
        if ((this.hasPlugin("v8intrinsic") ? Jt(o) : Jt(o) && !this.match(54)) && !this.isAmbiguousAwait())
    ...
    parseCoverCallAndAsyncArrowHead(t, r, e, s) {
      ...
      o && (this.expressionScope.enter(Nl()), a = new Nt()), c && (n.optional = s), s ? n.arguments = this.parseCallExpressionArguments(11) : n.arguments = this.parseCallExpressionArguments(11, t.type === "Import", t.type !== "Super", n, a);
    ...
    parseAsyncArrowFromCallExpression(t, r) {
      var e;
      return this.resetPreviousNodeTrailingComments(r), this.expect(19), this.parseArrowExpression(t, r.arguments, true, (e = r.extra) == null ? void 0 : e.trailingCommaLoc), r.innerComments && rt(t, r.innerComments), r.callee.trailingComments && rt(t, r.callee.trailingComments), t;
    }
    parseNoCallExpr() {
    ...
    finishTopicReference(t, r, e, s) {
      if (this.testTopicReferenceConfiguration(e, r, s)) {
        ...
        throw this.raise(u.PipeTopicUnconfiguredToken, { at: r, token: Ie(s) });
    }
    testTopicReferenceConfiguration(t, r, e) {
      switch (t) {
        case "hack":
          return this.hasPlugin(["pipelineOperator", { topicToken: Ie(e) }]);
        case "smart":
          return e === 27;
        default:
    ...
    parseAsyncArrowUnaryFunction(t) {
      this.prodParam.enter(It(true, this.prodParam.hasYield));
    ...
    parseDo(t, r) {
      ...
      return this.state.labels = [], r ? (this.prodParam.enter(wt), t.body = this.parseBlock(), this.prodParam.exit()) : t.body = this.parseBlock(), this.state.labels = e, this.finishNode(t, "DoExpression");
    }
    parseSuper() {
      let t = this.startNode();
    ...
    parseParenAndDistinguishExpression(t) {
      ...
      let a = this.state.startLoc, n = [], o = new Nt(), c = true, p, m;
      for (; !this.match(11); ) {
        if (c)
          c = false;
...
`), cooked: i === null ? null : i.slice(1, c) }, n.tail = o, this.next();
    ...
    parseObjectProperty(t, r, e, s) {
      ...
      if (!t.computed && t.key.type === "Identifier") {
        if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), e)
          t.value = this.parseMaybeDefault(r, Ce(t.key));
        else if (this.match(29)) {
          let i = this.state.startLoc;
          s != null ? s.shorthandAssignLoc === null && (s.shorthandAssignLoc = i) : this.raise(u.InvalidCoverInitializedName, { at: i }), t.value = this.parseMaybeDefault(r, Ce(t.key));
        } else
          t.value = Ce(t.key);
    ...
    parseMethod(t, r, e, s, i, a) {
      ...
      let o = s;
      this.scope.enter(Ee | xt | (n ? Be : 0) | (i ? Cr : 0)), this.prodParam.enter(It(e, t.generator)), this.parseFunctionParams(t, o);
    ...
    parseArrowExpression(t, r, e, s) {
      this.scope.enter(Ee | es);
      let i = It(e, false);
      !this.match(5) && this.prodParam.hasIn && (i |= Je), this.prodParam.enter(i), this.initFunction(t, e);
    ...
    parseFunctionBody(t, r) {
      ...
      if (this.expressionScope.enter(Hr()), s)
        t.body = this.parseMaybeAssign(), this.checkParams(t, false, r, false);
      else {
        let i = this.state.strict, a = this.state.labels;
        this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | Vr), t.body = this.parseBlock(true, false, (n) => {
          ...
          this.checkParams(t, !this.state.strict && !r && !e && !o, r, c), this.state.strict && t.id && this.checkIdentifier(t.id, tl, c);
    ...
    checkParams(t, r, e) {
      ...
      for (let n of t.params)
        this.checkLVal(n, { in: a, binding: vt, checkClashes: i, strictModeChanged: s });
    }
    ...
    checkReservedWord(t, r, e, s) {
      ...
      (this.state.strict ? s ? Er : Tr : Ar)(t, this.inModule) && this.raise(u.UnexpectedReservedWord, { at: r, reservedWord: t });
    }
    isAwaitAllowed() {
    ...
    isAmbiguousAwait() {
      if (this.hasPrecedingLineBreak())
        return true;
      let { type: t } = this.state;
      return t === 53 || t === 10 || t === 0 || yt(t) || t === 101 && !this.state.containsEsc || t === 135 || t === 56 || this.hasPlugin("v8intrinsic") && t === 54;
    }
    parseYield() {
      let t = this.startNode();
  ...
  }, xs = { kind: "loop" }, ah = { kind: "switch" }, le = { Expression: 0, Declaration: 1, HangingDeclaration: 2, NullableId: 4, Async: 8 }, he = { StatementOnly: 0, AllowImportExport: 1, AllowDeclaration: 2, AllowFunctionDeclaration: 4, AllowLabeledFunction: 8 }, nh = /[\uD800-\uDFFF]/u, gs = /in(?:stanceof)?/y;
  function oh(t, r) {
      ...
      if (typeof i == "number") {
        {
          if (i === 136) {
            ...
            t.splice(e, 1, new De({ type: Te(27), value: "#", start: n, end: p, startLoc: a.start, endLoc: m }), new De({ type: Te(130), value: o, start: p, end: c, startLoc: m, endLoc: a.end })), e++;
            continue;
          }
          if (yt(i)) {
            let { loc: a, start: n, value: o, end: c } = s, p = n + 1, m = y(a.start, 1), x;
            r.charCodeAt(n) === 96 ? x = new De({ type: Te(22), value: "`", start: n, end: p, startLoc: a.start, endLoc: m }) : x = new De({ type: Te(8), value: "}", start: n, end: p, startLoc: a.start, endLoc: m });
            let P, b, M, q;
            i === 24 ? (b = c - 1, M = y(a.end, -1), P = o === null ? null : o.slice(1, -1), q = new De({ type: Te(22), value: "`", start: b, end: c, startLoc: M, endLoc: a.end })) : (b = c - 2, M = y(a.end, -2), P = o === null ? null : o.slice(1, -2), q = new De({ type: Te(23), value: "${", start: b, end: c, startLoc: M, endLoc: a.end })), t.splice(e, 1, x, new De({ type: Te(20), value: P, start: p, end: b, startLoc: m, endLoc: M }), q), e += 2;
            continue;
          }
        }
        s.type = Te(i);
  ...
  var lh = class extends ih {
    parseTopLevel(t, r) {
      return t.program = this.parseProgram(r), t.comments = this.state.comments, this.options.tokens && (t.tokens = oh(this.tokens, this.input)), this.finishNode(t, "File");
    }
    parseProgram(t) {
    ...
    parseModuleItem() {
      return this.parseStatementLike(he.AllowImportExport | he.AllowDeclaration | he.AllowFunctionDeclaration | he.AllowLabeledFunction);
    }
    parseStatementListItem() {
      return this.parseStatementLike(he.AllowDeclaration | he.AllowFunctionDeclaration | he.AllowLabeledFunction);
    }
    parseStatementOrFunctionDeclaration(t) {
      return this.parseStatementLike(he.AllowFunctionDeclaration | (t ? 0 : he.AllowLabeledFunction));
    }
    parseStatement() {
      return this.parseStatementLike(he.StatementOnly);
    }
    ...
    parseStatementContent(t, r) {
      let e = this.state.type, s = this.startNode(), i = !!(t & he.AllowDeclaration), a = !!(t & he.AllowFunctionDeclaration), n = t & he.AllowImportExport;
      switch (e) {
        case 60:
    ...
    parseForStatement(t) {
      ...
      let r = null;
      if (this.isAwaitAllowed() && this.eatContextual(96) && (r = this.state.lastTokStartLoc), this.scope.enter(Ve), this.expect(10), this.match(13))
      ...
      if (this.match(74) || this.match(75) || i) {
        ...
        return P && s && this.raise(u.ForInUsing, { at: x }), (P || this.isContextual(101)) && x.declarations.length === 1 ? this.parseForIn(t, x, r) : (r !== null && this.unexpected(r), this.parseFor(t, x));
      }
      let a = this.isContextual(95), n = new Nt(), o = this.parseExpression(true, n), c = this.isContextual(101);
    ...
    parseFunctionStatement(t, r, e) {
      return this.next(), this.parseFunction(t, le.Declaration | (e ? le.HangingDeclaration : 0) | (r ? le.Async : 0));
    }
    parseIfStatement(t) {
    ...
    parseSwitchStatement(t) {
      ...
      let r = t.cases = [];
      this.expect(5), this.state.labels.push(ah), this.scope.enter(Ve);
      let e;
    ...
    parseCatchClauseParam() {
      ...
      return this.scope.enter(r ? br : 0), this.checkLVal(t, { in: { type: "CatchClause" }, binding: _e, allowingSloppyLetBinding: true }), t;
    }
    parseTryStatement(t) {
      if (this.next(), t.block = this.parseBlock(), t.handler = null, this.match(62)) {
        let r = this.startNode();
        this.next(), this.match(10) ? (this.expect(10), r.param = this.parseCatchClauseParam(), this.expect(11)) : (r.param = null, this.scope.enter(Ve)), r.body = this.withSmartMixTopicForbiddingContext(() => this.parseBlock(false, false)), this.scope.exit(), t.handler = this.finishNode(r, "CatchClause");
      }
    ...
    parseLabeledStatement(t, r, e, s) {
      ...
      return this.state.labels.push({ name: r, kind: i, statementStart: this.state.start }), t.body = s & he.AllowLabeledFunction ? this.parseStatementOrFunctionDeclaration(false) : this.parseStatement(), this.state.labels.pop(), t.label = e, this.finishNode(t, "LabeledStatement");
    }
    ...
    parseBlock() {
      ...
      return t && this.state.strictErrors.clear(), this.expect(5), r && this.scope.enter(Ve), this.parseBlockBody(s, t, false, 8, e), r && this.scope.exit(), this.finishNode(s, "BlockStatement");
    }
    isValidDirective(t) {
    ...
    parseVarId(t, r) {
      ...
      this.checkLVal(e, { in: { type: "VariableDeclarator" }, binding: r === "var" ? vt : _e }), t.id = e;
    }
    parseAsyncFunctionExpression(t) {
      return this.parseFunction(t, le.Async);
    }
    parseFunction(t) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : le.Expression, e = r & le.HangingDeclaration, s = !!(r & le.Declaration), i = s && !(r & le.NullableId), a = !!(r & le.Async);
      ...
      return this.state.maybeInArrowParameters = false, this.scope.enter(Ee), this.prodParam.enter(It(a, t.generator)), s || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, false), this.withSmartMixTopicForbiddingContext(() => {
    ...
    parseFunctionParams(t, r) {
      this.expect(10), this.expressionScope.enter(wl()), t.params = this.parseBindingList(11, 41, false, r), this.expressionScope.exit();
    }
    registerFunctionStatementId(t) {
      t.id && this.scope.declareName(t.id.name, this.state.strict || t.generator || t.async ? this.scope.treatFunctionsAsVar ? vt : _e : Nr, t.id.loc.start);
    }
    parseClass(t, r, e) {
      this.next();
    ...
    parseClassMemberWithIsStatic(t, r, e, s) {
      ...
      let x = z(this.state.type) && !this.state.containsEsc, P = this.match(136), b = this.parseClassElementName(r), M = this.state.startLoc;
      if (this.parsePostMemberNameModifiers(m), this.isClassMethod()) {
        if (p.kind = "method", P) {
          this.pushClassPrivateMethod(t, a, false, false);
          return;
        }
        let q = this.isNonstaticConstructor(i), te = false;
        q && (i.kind = "constructor", e.hadConstructor && !this.hasPlugin("typescript") && this.raise(u.DuplicateConstructor, { at: b }), q && this.hasPlugin("typescript") && r.override && this.raise(u.OverrideOnConstructor, { at: b }), e.hadConstructor = true, te = e.hadSuperClass), this.pushClassMethod(t, i, false, false, q, te);
      } else if (this.isClassProperty())
        ...
        let q = this.eat(55);
        m.optional && this.unexpected(M), p.kind = "method";
        let te = this.match(136);
        this.parseClassElementName(p), this.parsePostMemberNameModifiers(m), te ? this.pushClassPrivateMethod(t, a, q, true) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAsync, { at: i.key }), this.pushClassMethod(t, i, q, true, false, false));
        ...
        let q = this.match(136);
        this.parseClassElementName(i), q ? this.pushClassPrivateMethod(t, a, false, false) : (this.isNonstaticConstructor(i) && this.raise(u.ConstructorIsAccessor, { at: i.key }), this.pushClassMethod(t, i, false, false, false, false)), this.checkGetterSetterParams(i);
        ...
        let q = this.match(136);
        this.parseClassElementName(n), this.pushClassAccessorProperty(t, c, q);
      } else
    ...
    parseClassStaticBlock(t, r) {
      var e;
      this.scope.enter(Be | gt | xt);
      let s = this.state.labels;
      this.state.labels = [], this.prodParam.enter(Ge);
      let i = r.body = [];
    ...
    parseInitializer(t) {
      this.scope.enter(Be | xt), this.expressionScope.enter(Hr()), this.prodParam.enter(Ge), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
    }
    parseClassId(t, r, e) {
      let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : Ir;
      if (z(this.state.type))
    ...
    parseExportDefaultExpression() {
      let t = this.startNode();
      if (this.match(68))
        return this.next(), this.parseFunction(t, le.Declaration | le.NullableId);
      if (this.isAsyncFunction())
        return this.next(), this.next(), this.parseFunction(t, le.Declaration | le.NullableId | le.Async);
      if (this.match(80))
    ...
    parseExportSpecifier(t, r, e, s) {
      return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : r ? t.exported = Ll(t.local) : t.exported || (t.exported = Ce(t.local)), this.finishNode(t, "ExportSpecifier");
    }
    parseModuleExportName() {
      if (this.match(131)) {
        let t = this.parseStringLiteral(this.state.value), r = t.value.match(nh);
    ...
    parseImportSpecifier(t, r, e, s, i) {
      if (this.eatContextual(93))
        ...
        this.checkReservedWord(a.name, t.loc.start, true, true), t.local || (t.local = Ce(a));
      }
    ...
    constructor(t, r) {
      t = th(t), super(t, r), this.options = t, this.initializeScopes(), this.plugins = hh(this.options.plugins), this.filename = t.sourceFilename;
    }
    getScopeHandler() {
      return us;
    }
  ...
  function uh(t, r) {
    ...
    if (((e = r) == null ? void 0 : e.sourceType) === "unambiguous") {
      ...
      try {
        r.sourceType = "module";
        let s = ot(r, t), i = s.parse();
        if (s.sawUnambiguousESM)
          return i;
        if (s.ambiguousScriptDifferentAst)
          try {
            return r.sourceType = "script", ot(r, t).parse();
          } catch {
          }
        else
  ...
  function ot(t, r) {
    let e = ri;
    return t != null && t.plugins && (Zl(t.plugins), e = dh(t.plugins)), new e(t, r);
  }
  var ii = {};
  function dh(t) {
    let r = eh.filter((i) => re(t, i)), e = r.join("/"), s = ii[e];
    if (!s) {
      s = ri;
      for (let i of r)
        s = ei[i](s);
  ...
  l.parse = uh, l.parseExpression = ch, l.tokTypes = fh;
} });
var Bf = W({ "src/language-js/parse/json.js"(l, h) {
  "use strict";
  K();
  var f = dr(), d = mr(), y = wo(), g = Io();
  function A() {
    let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: O = true } = C;
    return function(N) {
      let { parseExpression: H } = Do(), J;
      try {
        J = H(N, { tokens: true, ranges: true });
      } catch (D) {
        throw g(D);
      }
      if (!O && f(J.comments))
        throw E(J.comments[0], "Comment");
      return S(J), J;
    };
  }
  function E(C, O) {
    let [R, N] = [C.loc.start, C.loc.end].map((H) => {
      let { line: J, column: D } = H;
      return { line: J, column: D + 1 };
    });
    return d(`${O} is not allowed in JSON.`, { start: R, end: N });
  }
  function S(C) {
    switch (C.type) {
      case "ArrayExpression":
      ...
      case "ObjectProperty":
        if (C.computed)
          throw E(C.key, "Computed key");
        if (C.shorthand)
          throw E(C.key, "Shorthand property");
        C.key.type !== "Identifier" && S(C.key), S(C.value);
        return;
      case "UnaryExpression": {
        let { operator: O, argument: R } = C;
        if (O !== "+" && O !== "-")
          throw E(C, `Operator '${C.operator}'`);
        if (R.type === "NumericLiteral" || R.type === "Identifier" && (R.name === "Infinity" || R.name === "NaN"))
          return;
        throw E(R, `Operator '${O}' before '${R.type}'`);
      }
      case "Identifier":
        if (C.name !== "Infinity" && C.name !== "NaN" && C.name !== "undefined")
          throw E(C, `Identifier '${C.name}'`);
        return;
      case "TemplateLiteral":
        if (f(C.expressions))
          throw E(C.expressions[0], "'TemplateLiteral' with expression");
        for (let O of C.quasis)
          S(O);
        return;
      case "NullLiteral":
      case "BooleanLiteral":
  ...
  var L = A(), I = { json: y({ parse: L, hasPragma() {
    return true;
  } }), json5: y(L), "json-stringify": y({ parse: A({ allowComments: false }), astFormat: "estree-json" }) };
  h.exports = I;
} });
var Mf = W({ "src/language-js/parse/babel.js"(l, h) {
  K();
  var f = yf(), d = uo(), y = Af(), g = wo(), A = Io(), E = Of(), S = Bf(), L = { sourceType: "module", allowImportExportEverywhere: true, allowReturnOutsideFunction: true, allowSuperOutsideMethod: true, allowUndeclaredExports: true, errorRecovery: true, createParenthesizedExpressions: true, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", ["decorators", { decoratorsBeforeExport: false }], "importAssertions", "decimal", "moduleBlocks", "asyncDoExpressions", "regexpUnicodeSets", "destructuringPrivate", "decoratorAutoAccessors"], tokens: true, ranges: true }, I = ["recordAndTuple", { syntaxType: "hash" }], C = "v8intrinsic", O = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "minimal" }], ["pipelineOperator", { proposal: "fsharp" }]], R = function(V) {
    let Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : L;
    return Object.assign(Object.assign({}, Y), {}, { plugins: [...Y.plugins, ...V] });
  }, N = /@(?:no)?flow\b/;
  function H(V, Y) {
    if (Y.filepath && Y.filepath.endsWith(".js.flow"))
      return true;
    let Pe = d(V);
    Pe && (V = V.slice(Pe.length));
    let ce = y(V, 0);
    return ce !== false && (V = V.slice(0, ce)), N.test(V);
  }
  function J(V, Y, Pe) {
    let ce = Do()[V], oe = ce(Y, Pe), j = oe.errors.find((G) => !ee.has(G.reasonCode));
    if (j)
      throw j;
    return oe;
  }
  function D(V) {
    for (var Y = arguments.length, Pe = new Array(Y > 1 ? Y - 1 : 0), ce = 1; ce < Y; ce++)
      Pe[ce - 1] = arguments[ce];
    return function(oe, j) {
      let G = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      if ((G.parser === "babel" || G.parser === "__babel_estree") && H(oe, G))
        return G.parser = "babel-flow", u(oe, j, G);
      let ae = Pe;
      G.__babelSourceType === "script" && (ae = ae.map((fe) => Object.assign(Object.assign({}, fe), {}, { sourceType: "script" }))), /#[[{]/.test(oe) && (ae = ae.map((fe) => R([I], fe)));
      let pe = /%[A-Z]/.test(oe);
      oe.includes("|>") ? ae = (pe ? [...O, C] : O).flatMap((et) => ae.map((tt) => R([et], tt))) : pe && (ae = ae.map((fe) => R([C], fe)));
      let { result: He, error: Ze } = f(...ae.map((fe) => () => J(V, oe, fe)));
      if (!He)
        throw A(Ze);
      return G.originalText = oe, E(He, G);
    };
  }
  var _ = D("parse", R(["jsx", "flow"])), u = D("parse", R(["jsx", ["flow", { all: true, enums: true }]])), X = D("parse", R(["jsx", "typescript"]), R(["typescript"])), ne = D("parse", R(["jsx", "flow", "estree"])), Q = D("parseExpression", R(["jsx"])), we = D("parseExpression", R(["typescript"])), ee = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), U = g(_), B = g(X), T = g(Q), Oe = g(we);
  h.exports = { parsers: Object.assign(Object.assign({ babel: U, "babel-flow": g(u), "babel-ts": B }, S), {}, { __js_expression: T, __vue_expression: T, __vue_ts_expression: Oe, __vue_event_binding: U, __vue_ts_event_binding: B, __babel_estree: g(ne) }) };
} });
var Pm = Mf();
export {
  Pm as default
