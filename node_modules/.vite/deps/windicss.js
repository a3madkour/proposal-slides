...
function guessClassName(selector) {
  ...
  if (selector.indexOf(",") >= 0) {
    ...
    if (splittedSelectors.length !== 1)
      return splittedSelectors.map(function(i) {
...
function generateOrientations(orientations) {
  ...
  Object.entries(orientations).forEach(function(_a) {
    ...
    variants[name] = function() {
      return new Style().atRule("@media (orientation: ".concat(orientation, ")"));
    };
  });
  return variants;
}
...
function generateStates(variantOrder2) {
  var peseudoClassStates = pseudoClassNames.reduce(function(o, pseudoClassName) {
    return o[pseudoClassName] = function() {
      return new Style().pseudoClass(pseudoClassName);
    }, o;
  }, {});
  var peerStates = pseudoClassNames.reduce(function(o, pseudoClassName) {
    return o["peer-".concat(pseudoClassName)] = function() {
      return new Style().parent(".peer:".concat(pseudoClassName, " ~"));
    }, o;
  }, {});
  var notPeerStates = pseudoClassNames.reduce(function(o, pseudoClassName) {
    return o["peer-not-".concat(pseudoClassName)] = function() {
      return new Style().parent(".peer:not(:".concat(pseudoClassName, ") ~"));
    }, o;
  }, {});
  var groupStates = pseudoClassNames.reduce(function(o, pseudoClassName) {
    return o["group-".concat(pseudoClassName)] = function() {
      return new Style().parent(".group:".concat(pseudoClassName));
    }, o;
  }, {});
  var states = __assign(__assign(__assign(__assign(__assign(__assign({}, peseudoClassStates), {
    ...
    selection: function() {
      return new Style().wrapSelector(function(selector) {
        return "".concat(selector, " *::selection, ").concat(selector, "::selection");
      });
    },
    marker: function() {
      return new Style().wrapSelector(function(selector) {
        return "".concat(selector, " *::marker, ").concat(selector, "::marker");
      });
    },
    svg: function() {
...
function basis(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("spacing")).handleNumber(1, Infinity, void 0, function(number) {
    return "".concat(number / 4, "rem");
  }).handleSize().handleFraction().handleVariable().handleSquareBrackets().createProperty("flex-basis")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "flexBasis", pluginOrder.flexBasis, 1, true);
}
...
function gridTemplate(utility, _a) {
  ...
  return ((_b = utility.handler.handleStatic(theme(group)).handleSquareBrackets(function(i) {
    return i.replace(
      ...
      /* ignore content inside nested-brackets */
    ).replace(/_/g, " ");
...
function columns(utility, _a) {
  var _b;
  var theme = _a.theme;
  return (_b = utility.handler.handleStatic(theme("columns")).handleSquareBrackets().handleSize().handleNxl(function(number) {
    return "".concat((number - 3) * 8 + 48, "rem");
  }).handleVariable().createProperty("columns")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "columns", pluginOrder.columns, 1, true);
}
...
function textDecoration(utility, _a) {
  ...
  return (
    ...
    ((_b = utility.handler.handleColor(theme("textDecorationColor")).handleOpacity(theme("textDecorationOpacity")).handleSquareBrackets(notNumberLead).handleVariable().createColorStyle(utility.class, ["-webkit-text-decoration-color", "text-decoration-color"], "--tw-text-decoration-opacity")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "textDecorationColor", pluginOrder.textDecorationColor, 1, true)) || ((_c = utility.handler.handleStatic(theme("textDecorationThickness")).handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "px");
    }).handleSize().createProperty("text-decoration-thickness")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "textDecorationThickness", pluginOrder.textDecorationThickness, 1, true))
  );
}
function textUnderline(utility, _a) {
  ...
  if (utility.raw.startsWith("underline-offset")) {
    return (_b = utility.handler.handleStatic(theme("textDecorationOffset")).handleNumber(0, void 0, "int", function(number) {
      return "".concat(number, "px");
    }).handleSize().createProperty("text-underline-offset")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "textDecorationOffset", pluginOrder.textDecorationOffset, 1, true);
  }
  if (utility.raw.startsWith("underline-opacity")) {
    return (_c = utility.handler.handleStatic(theme("textDecorationOpacity")).handleNumber(0, 100, "int", function(number) {
      return (number / 100).toString();
    }).handleVariable().createProperty("--tw-line-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "textDecorationOpacity", pluginOrder.textDecorationOpacity, 1, true);
  }
...
function border(utility, _a) {
  ...
  return (_g = utility.handler.handleStatic(borders).handleSquareBrackets().handleNumber(0, void 0, "int", function(number) {
    return /^border(-[tlbrxy])?$/.test(utility.key) ? "".concat(number, "px") : void 0;
...
function boxShadow(utility, _a) {
  ...
  var color = utility.handler.handleColor(theme("boxShadowColor")).handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable();
  return new Style(utility.class, [
...
function outline(utility, _a) {
  ...
  if (utility.raw.startsWith("outline-offset")) {
    return (_b = utility.handler.handleStatic(theme("outlineOffset")).handleNumber(0, void 0, "int").handleVariable().handleSquareBrackets().createProperty("outline-offset")) === null || _b === void 0 ? void 0 : _b.updateMeta("utilities", "outline", pluginOrder.outline, 0, true);
  }
  if (utility.raw.startsWith("outline-opacity")) {
    return (_c = utility.handler.handleStatic(theme("opacity")).handleNumber(0, 1, "float").handleVariable().handleSquareBrackets().createProperty("--tw-outline-opacity")) === null || _c === void 0 ? void 0 : _c.updateMeta("utilities", "outline", pluginOrder.outline, 1, true);
  }
  var outlineColor = (_d = utility.handler.handleColor(theme("outlineColor")).handleOpacity(theme("opacity")).handleSquareBrackets(notNumberLead).handleVariable(function(variable) {
  ...
  if (outlineColor)
    return outlineColor;
  return (_e = utility.handler.handleStatic(theme("outlineWidth")).handleNumber(0, void 0, "float", function(number) {
    return "".concat(number, "px");
  }).handleSquareBrackets().handleVariable().createProperty("outline-width")) === null || _e === void 0 ? void 0 : _e.updateMeta("utilities", "outline", pluginOrder.outline, 3, true);
}
...
function accent(utility, _a) {
  var theme = _a.theme;
  var color = utility.handler.handleColor(theme("boxShadowColor")).handleOpacity(theme("opacity")).handleSquareBrackets().handleVariable().createColorValue("1");
  return new Style(utility.class, new Property("accent-color", color)).updateMeta("utilities", "accentColor", pluginOrder.accentColor, 0, true);
}
...
var baseConfig = {
  ...
  theme: {
    ...
    maxHeight: function(theme, _a) {
      var _b, _c;
      var breakpoints2 = _a.breakpoints;
      return __assign(__assign(__assign(__assign({}, breakpoints2((_b = theme("screens")) !== null && _b !== void 0 ? _b : {})), (_c = theme("spacing")) !== null && _c !== void 0 ? _c : {}), tShirtScale), { none: "none", full: "100%", min: "min-content", max: "max-content", prose: "65ch", screen: "100vh" });
    },
    maxWidth: function(theme, _a) {
      var _b, _c;
      var breakpoints2 = _a.breakpoints;
      return __assign(__assign(__assign(__assign({}, breakpoints2((_b = theme("screens")) !== null && _b !== void 0 ? _b : {})), (_c = theme("spacing")) !== null && _c !== void 0 ? _c : {}), tShirtScale), { none: "none", full: "100%", min: "min-content", max: "max-content", prose: "65ch", screen: "100vw" });
    },
  ...
  return function(utility, value, color) {
    var handler = {
      ...
      createColorStyle: function(selector, property, opacityVariable, wrapRGB) {
        ...
        if (!color2)
          return;
        if (["transparent", "currentColor", "inherit", "auto", "none"].includes(color2) || color2.includes("var"))
...
function preflight(processor, html, includeBase, includeGlobal, includePlugins) {
  ...
  var tags = html ? safelist.concat(Array.from(new Set(html.match(/<\w+/g))).map(function(i) {
          ...
          case "object":
            theme[key2] = function(theme2, _a2) {
              ...
              return combineConfig(
                themeValue,
                typeof value2 === "function" ? value2(theme2, { negative: negative2, breakpoints: breakpoints2 }) : value2 !== null && value2 !== void 0 ? value2 : {},
                0
                /* prevent fontfamily merge */
              );
            };
            break;
          default:
